...
BEACON_MARGIN = int(os.environ.get("CAPROTO_CLIENT_BEACON_MARGIN", 1))
EVENT_ADD_BATCH_MAX_BYTES = int(
    os.environ.get("CAPROTO_CLIENT_EVENT_ADD_BATCH_MAX_BYTES", 2 ** 16)
)
MAX_RETRY_SEARCHES_INTERVAL = int(
    os.environ.get("CAPROTO_CLIENT_MAX_RETRY_SEARCHES_INTERVAL", 5)
)
MIN_RETRY_SEARCHES_INTERVAL = float(
    os.environ.get("CAPROTO_CLIENT_MIN_RETRY_SEARCHES_INTERVAL", 0.03)
)
RESTART_SUBS_PERIOD = int(os.environ.get("CAPROTO_CLIENT_RESTART_SUBS_PERIOD", 0.1))
RETRY_RETIRED_SEARCHES_INTERVAL = int(
    os.environ.get("CAPROTO_CLIENT_RETRY_RETIRED_SEARCHES_INTERVAL", 60)
)
SEARCH_RETIREMENT_AGE = int(
    os.environ.get("CAPROTO_CLIENT_SEARCH_RETIREMENT_AGE", 8 * 60)
)
