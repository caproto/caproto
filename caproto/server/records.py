...
class RecordFieldGroup(PVGroup):
    ...
    description = pvproperty(name='DESC',
                             dtype=ChannelType.STRING,
                             doc='Descriptor')
    scan_disable_input_link_value = pvproperty(name='DISA',
                                               dtype=ChannelType.LONG,
                                               doc='Disable')
    disable_putfields = pvproperty(name='DISP',
    ...
    device_type = pvproperty(name='DTYP',
                             dtype=ChannelType.STRING,
                             doc='Device Type')
    event_number = pvproperty(name='EVNT',
                              dtype=ChannelType.STRING,
                              doc='Event Number')
    ...
    new_alarm_status = pvproperty(
        ...
        read_only=True)
    processing_active = pvproperty(name='PACT',
                                   dtype=ChannelType.CHAR,
                                   doc='Record active',
                                   read_only=True)
    scan_phase_number = pvproperty(name='PHAS',
                                   dtype=ChannelType.LONG,
                                   doc='Scan Phase')
    ...
    scan_rate = pvproperty(name='SCAN',
                           ...
                           doc='Scan Mechanism')
    scan_disable_input_link = pvproperty(name='SDIS',
                                         dtype=ChannelType.STRING,
    ...
    time_stamp_event_link = pvproperty(name='TSEL',
                                       dtype=ChannelType.STRING,
                                       doc='Time Stamp Link')
    val_undefined = pvproperty(name='UDF',
                               dtype=ChannelType.CHAR,
                               doc='Undefined')
...
class AiFields(RecordFieldGroup, _Limits):
    ...
    previous_raw_value = pvproperty(name='ORAW',
                                    ...
                                    read_only=True)
    raw_offset_obsolete = pvproperty(name='ROFF',
                                     dtype=ChannelType.LONG,
                                     doc='Raw Offset, obsolete')
...
class AsubFields(RecordFieldGroup):
    ...
    initialize_subroutine_name = pvproperty(name='INAM',
                                            dtype=ChannelType.CHAR,
                                            max_length=41,
                                            doc='Initialize Subr. Name',
                                            read_only=True)
    old_subroutine_name = pvproperty(name='ONAM',
                                     dtype=ChannelType.CHAR,
                                     max_length=41,
                                     doc='Old Subr. Name',
                                     read_only=True)
    process_subroutine_name = pvproperty(name='SNAM',
                                         dtype=ChannelType.CHAR,
                                         max_length=41,
...
class AaiFields(RecordFieldGroup):
    ...
    input_specification = pvproperty(name='INP',
                                     dtype=ChannelType.STRING,
                                     doc='Input Specification')
    engineering_units_name = pvproperty(name='EGU',
                                        dtype=ChannelType.CHAR,
                                        max_length=16,
...
class AcalcoutFields(RecordFieldGroup, _Limits):
    ...
    alarm_status = pvproperty(
        ...
        doc='Alarm Status',
        read_only=True)
    array_mod = pvproperty(name='AMASK',
                           dtype=ChannelType.LONG,
                           doc='Array mod',
                           read_only=True)
    ...
    calc_valid = pvproperty(name='CLCV',
                            dtype=ChannelType.LONG,
                            doc='CALC Valid')
    calc_active = pvproperty(name='CACT',
                             dtype=ChannelType.CHAR,
                             doc='Calc active',
                             read_only=True)
    calc_status = pvproperty(name='CSTAT',
                             dtype=ChannelType.LONG,
                             doc='Calc status',
                             read_only=True)
    ...
    new_array_value_mask = pvproperty(name='NEWM',
                                      dtype=ChannelType.LONG,
    ...
    output_link = pvproperty(name='OUT',
                             dtype=ChannelType.STRING,
                             doc='Output Link')
    elem_s_in_use = pvproperty(name='NUSE',
                               dtype=ChannelType.LONG,
                               doc="# elem's in use")
    number_of_elements = pvproperty(name='NELM',
                                    dtype=ChannelType.LONG,
...
class AoFields(RecordFieldGroup, _Limits):
    ...
    output_rate_of_chang = pvproperty(name='OROC',
                                      dtype=ChannelType.DOUBLE,
                                      doc='Output Rate of Chang')
    output_specification = pvproperty(name='OUT',
                                      dtype=ChannelType.STRING,
                                      doc='Output Specification')
    _link_parent_attribute(display_precision, 'precision')
...
class AsynFields(RecordFieldGroup):
    ...
    eom_reason = pvproperty(
        ...
        doc='EOM reason',
        read_only=True)
    input_response_string = pvproperty(name='AINP',
                                       dtype=ChannelType.CHAR,
                                       max_length=40,
    ...
    asynuser_reason = pvproperty(name='REASON',
                                 dtype=ChannelType.LONG,
                                 doc='asynUser->reason')
    trace_io_mask = pvproperty(name='TIOM',
                               dtype=ChannelType.LONG,
                               doc='Trace I/O mask')
    ...
    baud_rate = pvproperty(name='BAUD',
                           ...
                           doc='Baud rate')
    baud_rate_lbaud = pvproperty(name='LBAUD',
                                 dtype=ChannelType.LONG,
                                 doc='Baud rate')
    ...
    stop_bits = pvproperty(name='SBIT',
                           ...
                           doc='Stop bits')
    timeout_sec = pvproperty(name='TMOT',
                             dtype=ChannelType.DOUBLE,
                             doc='Timeout (sec)')
    ...
    output_command_string = pvproperty(name='AOUT',
                                       dtype=ChannelType.CHAR,
                                       max_length=40,
...
class CompressFields(RecordFieldGroup):
    ...
    display_precision = pvproperty(name='PREC',
                                   dtype=ChannelType.LONG,
                                   doc='Display Precision')
    engineeringunits = pvproperty(name='EGU',
                                  dtype=ChannelType.CHAR,
                                  max_length=16,
...
class DigitelFields(RecordFieldGroup):
    ...
    acc_current = pvproperty(name='ACCI',
                             dtype=ChannelType.DOUBLE,
                             doc='Acc Current',
                             read_only=True)
    acc_power = pvproperty(name='ACCW',
                           dtype=ChannelType.DOUBLE,
                           doc='Acc Power',
                           read_only=True)
    alarm_status = pvproperty(
    ...
    bake_time_mode_read = pvproperty(
        ...
        read_only=True)
    bake_time_read = pvproperty(name='S3TR',
                                dtype=ChannelType.DOUBLE,
                                doc='Bake Time Read',
                                read_only=True)
    bake_time_set = pvproperty(name='S3TS',
                               dtype=ChannelType.DOUBLE,
                               doc='Bake Time Set')
    cooldown_mode = pvproperty(
        ...
        doc='Cooldown Mode',
        read_only=True)
    cooldown_time = pvproperty(name='COOL',
                               dtype=ChannelType.DOUBLE,
                               doc='Cooldown Time',
                               read_only=True)
    current = pvproperty(name='CRNT',
                         dtype=ChannelType.DOUBLE,
                         doc='Current',
                         read_only=True)
    cycle_count = pvproperty(name='CYCL',
                             dtype=ChannelType.LONG,
                             doc='Cycle count',
                             read_only=True)
    error_count = pvproperty(name='ERR',
                             dtype=ChannelType.LONG,
                             doc='Error Count',
                             read_only=True)
    last_value_alarmed = pvproperty(name='LALM',
                                    ...
                                    doc='Last Value Alarmed',
                                    read_only=True)
    mod_flags = pvproperty(name='FLGS',
                           dtype=ChannelType.LONG,
                           doc='Mod Flags',
                           read_only=True)
    mode_readback = pvproperty(
        ...
        doc='Mode Readback',
        read_only=True)
    pressure_log10_form = pvproperty(name='LVAL',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Pressure (log10 form)',
                                     read_only=True)
    pump_type = pvproperty(name='PTYP',
                           dtype=ChannelType.ENUM,
    ...
    sp1_hvi_readback = pvproperty(
        ...
        read_only=True)
    sp1_hy_readback = pvproperty(name='S1HR',
                                 dtype=ChannelType.DOUBLE,
                                 doc='SP1 HY Readback',
                                 read_only=True)
    sp1_hysteresis = pvproperty(name='S1HS',
                                dtype=ChannelType.DOUBLE,
                                doc='SP1 Hysteresis')
    sp1_mode_readback = pvproperty(
        ...
        read_only=True)
    sp1_sp_readback = pvproperty(name='SP1R',
                                 dtype=ChannelType.DOUBLE,
                                 doc='SP1 SP Readback',
                                 read_only=True)
    sp1_setpoint = pvproperty(name='SP1S',
                              dtype=ChannelType.DOUBLE,
                              doc='SP1 Setpoint')
    sp2_hvi_readback = pvproperty(
        ...
        read_only=True)
    sp2_hy_readback = pvproperty(name='S2HR',
                                 dtype=ChannelType.DOUBLE,
                                 doc='SP2 HY Readback',
                                 read_only=True)
    sp2_hysteresis = pvproperty(name='S2HS',
                                dtype=ChannelType.DOUBLE,
                                doc='SP2 Hysteresis')
    sp2_mode_readback = pvproperty(
        ...
        read_only=True)
    sp2_sp_readback = pvproperty(name='SP2R',
                                 dtype=ChannelType.DOUBLE,
                                 doc='SP2 SP Readback',
                                 read_only=True)
    sp2_setpoint = pvproperty(name='SP2S',
                              dtype=ChannelType.DOUBLE,
                              doc='SP2 Setpoint')
    sp3_hvi_readback = pvproperty(
        ...
        read_only=True)
    sp3_hy_readback = pvproperty(name='S3HR',
                                 dtype=ChannelType.DOUBLE,
                                 doc='SP3 HY Readback',
                                 read_only=True)
    sp3_hysteresis = pvproperty(name='S3HS',
                                dtype=ChannelType.DOUBLE,
                                doc='SP3 Hysteresis')
    sp3_mode_readback = pvproperty(
        ...
        read_only=True)
    sp3_sp_readback = pvproperty(name='SP3R',
                                 dtype=ChannelType.DOUBLE,
                                 doc='SP3 SP Readback',
                                 read_only=True)
    sp3_setpoint = pvproperty(name='SP3S',
                              dtype=ChannelType.DOUBLE,
                              doc='SP3 Setpoint')
    setpoint_1 = pvproperty(name='SET1',
                            dtype=ChannelType.ENUM,
                            enum_strings=menus.digitelSET1.get_string_tuple(),
                            doc='Setpoint 1',
                            read_only=True)
    setpoint_2 = pvproperty(name='SET2',
                            dtype=ChannelType.ENUM,
                            enum_strings=menus.digitelSET1.get_string_tuple(),
                            doc='Setpoint 2',
                            read_only=True)
    setpoint_3 = pvproperty(name='SET3',
                            dtype=ChannelType.ENUM,
                            enum_strings=menus.digitelSET1.get_string_tuple(),
                            doc='Setpoint 3',
                            read_only=True)
    setpoint_flags = pvproperty(name='SPFG',
                                dtype=ChannelType.LONG,
                                doc='Setpoint Flags',
                                read_only=True)
    sim_mode_value = pvproperty(
        ...
        enum_strings=menus.menuYesNo.get_string_tuple(),
        doc='Sim Mode Value')
    sim_value_current = pvproperty(name='SVCR',
                                   dtype=ChannelType.DOUBLE,
                                   doc='Sim Value Current')
    ...
    sim_value_sp2 = pvproperty(
        ...
        enum_strings=menus.digitelSET1.get_string_tuple(),
        doc='Sim Value SP2')
    time_online = pvproperty(name='TONL',
                             dtype=ChannelType.LONG,
                             doc='Time Online',
                             read_only=True)
    voltage = pvproperty(name='VOLT',
                         dtype=ChannelType.DOUBLE,
                         doc='Voltage',
                         read_only=True)
    init_acc_current = pvproperty(name='IACI',
                                  dtype=ChannelType.DOUBLE,
                                  doc='init Acc current',
                                  read_only=True)
    init_acc_power = pvproperty(name='IACW',
                                dtype=ChannelType.DOUBLE,
                                doc='init Acc power',
                                read_only=True)
    init_bake_installed = pvproperty(
        ...
        read_only=True)
    init_error_count = pvproperty(name='IERR',
                                  dtype=ChannelType.LONG,
                                  doc='init Error Count',
                                  read_only=True)
    init_bake = pvproperty(name='IBAK',
                           dtype=ChannelType.ENUM,
                           enum_strings=menus.digitelBAKS.get_string_tuple(),
                           doc='init bake',
                           read_only=True)
    init_cooldown_time = pvproperty(name='ICOL',
                                    dtype=ChannelType.DOUBLE,
                                    doc='init cooldown time',
                                    read_only=True)
    init_current = pvproperty(name='ICRN',
                              dtype=ChannelType.DOUBLE,
                              doc='init current',
                              read_only=True)
    init_mode = pvproperty(name='IMOD',
                           dtype=ChannelType.ENUM,
                           enum_strings=menus.digitelMODS.get_string_tuple(),
                           doc='init mode',
                           read_only=True)
    init_pressure = pvproperty(name='IVAL',
                               dtype=ChannelType.DOUBLE,
                               doc='init pressure',
                               read_only=True)
    init_pressure_log10 = pvproperty(name='ILVA',
                                     dtype=ChannelType.DOUBLE,
    ...
    init_pump_type = pvproperty(
        ...
        doc='init pump type',
        read_only=True)
    init_set1 = pvproperty(name='ISP1',
                           dtype=ChannelType.ENUM,
                           enum_strings=menus.digitelSET1.get_string_tuple(),
                           doc='init set1',
                           read_only=True)
    init_set2 = pvproperty(name='ISP2',
                           dtype=ChannelType.ENUM,
                           enum_strings=menus.digitelSET1.get_string_tuple(),
                           doc='init set2',
                           read_only=True)
    init_set3 = pvproperty(name='ISP3',
                           dtype=ChannelType.ENUM,
                           enum_strings=menus.digitelSET1.get_string_tuple(),
                           doc='init set3',
                           read_only=True)
    init_sp1 = pvproperty(name='IS1',
                          dtype=ChannelType.DOUBLE,
                          doc='init sp1',
                          read_only=True)
    init_sp1_hvi = pvproperty(
        ...
        doc='init sp1 HVI',
        read_only=True)
    init_sp1_hy = pvproperty(name='IH1',
                             dtype=ChannelType.DOUBLE,
                             doc='init sp1 HY',
                             read_only=True)
    ...
    init_sp2_hvi = pvproperty(
        ...
        doc='init sp2 HVI',
        read_only=True)
    init_sp2_hy = pvproperty(name='IH2',
                             dtype=ChannelType.DOUBLE,
                             doc='init sp2 HY',
                             read_only=True)
    ...
    init_sp3_hvi = pvproperty(
        ...
        doc='init sp3 HVI',
        read_only=True)
    init_sp3_hy = pvproperty(name='IH3',
                             dtype=ChannelType.DOUBLE,
                             doc='init sp3 HY',
                             read_only=True)
    init_sp3_bake_time = pvproperty(name='IT3',
                                    dtype=ChannelType.DOUBLE,
    ...
    init_sp3_mode = pvproperty(
        ...
        doc='init sp3 mode',
        read_only=True)
    init_tonl = pvproperty(name='ITON',
                           dtype=ChannelType.LONG,
                           doc='init tonl',
                           read_only=True)
    init_voltage = pvproperty(name='IVOL',
                              dtype=ChannelType.DOUBLE,
                              doc='init voltage',
                              read_only=True)
    alarm_deadband = pvproperty(name='HYST',
    ...
    display_mode = pvproperty(
        ...
        doc='Display Mode')
    pressure_high_alarm = pvproperty(name='HIGH',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Pressure High Alarm')
    pressure_high_severity = pvproperty(
        name='HSV',
        dtype=ChannelType.ENUM,
        enum_strings=menus.menuAlarmSevr.get_string_tuple(),
        doc='Pressure High Severity')
    pressure_hihi_alarm = pvproperty(name='HIHI',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Pressure Hihi Alarm')
    pressure_hihi_severity = pvproperty(
        name='HHSV',
        dtype=ChannelType.ENUM,
        enum_strings=menus.menuAlarmSevr.get_string_tuple(),
        doc='Pressure Hihi Severity')
    pressure_lolo_alarm = pvproperty(name='LOLO',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Pressure Lolo Alarm')
    pressure_lolo_severity = pvproperty(
        name='LLSV',
        dtype=ChannelType.ENUM,
        enum_strings=menus.menuAlarmSevr.get_string_tuple(),
        doc='Pressure Lolo Severity')
    pressure_low_alarm = pvproperty(name='LOW',
                                    dtype=ChannelType.DOUBLE,
                                    doc='Pressure Low Alarm')
    ...
    controller_type = pvproperty(
        ...
        doc='Controller Type')
    mode = pvproperty(name='MODS',
                      dtype=ChannelType.ENUM,
                      enum_strings=menus.digitelMODS.get_string_tuple(),
                      doc='Mode')
    device_specification = pvproperty(name='INP',
                                      dtype=ChannelType.STRING,
                                      doc='Device Specification',
                                      read_only=True)
    log_pres_display_hi = pvproperty(name='HLPR',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Log Pres Display Hi')
    log_pres_display_lo = pvproperty(name='LLPR',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Log Pres Display Lo')
    sim_location_current = pvproperty(name='SLCR',
                                      dtype=ChannelType.STRING,
                                      doc='Sim Location Current',
                                      read_only=True)
    sim_location_mode = pvproperty(name='SLMO',
                                   dtype=ChannelType.STRING,
                                   doc='Sim Location Mode',
                                   read_only=True)
    sim_location_sp1 = pvproperty(name='SLS1',
                                  dtype=ChannelType.STRING,
                                  doc='Sim Location SP1',
                                  read_only=True)
    sim_location_sp2 = pvproperty(name='SLS2',
                                  dtype=ChannelType.STRING,
    ...
    sp2_mode = pvproperty(name='S2MS',
                          dtype=ChannelType.ENUM,
                          enum_strings=menus.digitelS1MS.get_string_tuple(),
                          doc='SP2 Mode')
    sp3_mode = pvproperty(name='S3MS',
                          dtype=ChannelType.ENUM,
                          enum_strings=menus.digitelS1MS.get_string_tuple(),
                          doc='SP3 Mode')
    ...
    voltage_display_lo = pvproperty(name='LVTR',
                                    dtype=ChannelType.DOUBLE,
                                    doc='Voltage Display Lo')
    pressure_display_hi = pvproperty(name='HOPR',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Pressure Display Hi')
    pressure_display_lo = pvproperty(name='LOPR',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Pressure Display Lo')
    current_display_hi = pvproperty(name='HCTR',
                                    dtype=ChannelType.DOUBLE,
                                    doc='Current Display Hi')
    current_display_lo = pvproperty(name='LCTR',
                                    dtype=ChannelType.DOUBLE,
                                    doc='Current Display Lo')
    voltage_display_hi = pvproperty(name='HVTR',
                                    dtype=ChannelType.DOUBLE,
                                    doc='Voltage Display Hi')
...
class EpidFields(RecordFieldGroup):
    ...
    alarm_status = pvproperty(
        ...
        doc='Alarm Status',
        read_only=True)
    controlled_value = pvproperty(name='CVAL',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Controlled Value',
                                  read_only=True)
    d_component = pvproperty(name='D',
                             dtype=ChannelType.DOUBLE,
                             doc='D component',
                             read_only=True)
    delta_t = pvproperty(name='DT', dtype=ChannelType.DOUBLE, doc='Delta T')
    error = pvproperty(name='ERR',
                       dtype=ChannelType.DOUBLE,
                       doc='Error',
                       read_only=True)
    i_component = pvproperty(name='I',
                             dtype=ChannelType.DOUBLE,
                             doc='I component')
    last_value_alarmed = pvproperty(name='LALM',
                                    dtype=ChannelType.DOUBLE,
    ...
    output_value = pvproperty(name='OVAL',
                              ...
                              doc='Output value',
                              read_only=True)
    p_component = pvproperty(name='P',
                             dtype=ChannelType.DOUBLE,
                             doc='P component',
                             read_only=True)
    prev_output = pvproperty(name='OVLP',
                             dtype=ChannelType.DOUBLE,
                             doc='Prev output',
                             read_only=True)
    prev_controlled_value = pvproperty(name='CVLP',
                                       dtype=ChannelType.DOUBLE,
                                       doc='Prev. Controlled Value',
                                       read_only=True)
    prev_d_component = pvproperty(name='DP',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Prev. D component',
                                  read_only=True)
    prev_delta_t = pvproperty(name='DTP',
                              dtype=ChannelType.DOUBLE,
                              doc='Prev. Delta T')
    prev_error = pvproperty(name='ERRP',
                            dtype=ChannelType.DOUBLE,
                            doc='Prev. Error',
                            read_only=True)
    prev_i_component = pvproperty(name='IP',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Prev. I component')
    prev_p_component = pvproperty(name='PP',
                                  dtype=ChannelType.DOUBLE,
    ...
    alarm_deadband = pvproperty(name='HYST',
                                dtype=ChannelType.DOUBLE,
                                doc='Alarm Deadband')
    high_deviation_limit = pvproperty(name='HIGH',
                                      dtype=ChannelType.DOUBLE,
                                      doc='High Deviation Limit')
    high_severity = pvproperty(
        name='HSV',
        dtype=ChannelType.ENUM,
        enum_strings=menus.menuAlarmSevr.get_string_tuple(),
        doc='High Severity')
    hihi_deviation_limit = pvproperty(name='HIHI',
                                      dtype=ChannelType.DOUBLE,
                                      doc='Hihi Deviation Limit')
    hihi_severity = pvproperty(
        name='HHSV',
        dtype=ChannelType.ENUM,
        enum_strings=menus.menuAlarmSevr.get_string_tuple(),
        doc='Hihi Severity')
    lolo_deviation_limit = pvproperty(name='LOLO',
                                      dtype=ChannelType.DOUBLE,
                                      doc='Lolo Deviation Limit')
    lolo_severity = pvproperty(
        name='LLSV',
        dtype=ChannelType.ENUM,
        enum_strings=menus.menuAlarmSevr.get_string_tuple(),
        doc='Lolo Severity')
    low_deviation_limit = pvproperty(name='LOW',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Low Deviation Limit')
    low_severity = pvproperty(
        name='LSV',
        dtype=ChannelType.ENUM,
        enum_strings=menus.menuAlarmSevr.get_string_tuple(),
    ...
    engineering_units = pvproperty(name='EGU',
                                   ...
                                   max_length=16,
                                   doc='Engineering Units')
    high_drive_limit = pvproperty(name='DRVH',
                                  dtype=ChannelType.DOUBLE,
                                  doc='High Drive Limit')
    high_operating_range = pvproperty(name='HOPR',
                                      dtype=ChannelType.DOUBLE,
                                      doc='High Operating Range')
    low_drive_limit = pvproperty(name='DRVL',
                                 dtype=ChannelType.DOUBLE,
                                 doc='Low Drive Limit')
    low_operating_range = pvproperty(name='LOPR',
                                     dtype=ChannelType.DOUBLE,
    ...
    monitor_deadband = pvproperty(name='MDEL',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Monitor Deadband')
    controlled_value_loc = pvproperty(name='INP',
                                      dtype=ChannelType.STRING,
                                      doc='Controlled Value Loc')
    derivative_gain = pvproperty(name='KD',
                                 dtype=ChannelType.DOUBLE,
                                 doc='Derivative Gain')
    ...
    feedback_on_off = pvproperty(
        ...
        doc='Feedback On/Off')
    intergral_gain = pvproperty(name='KI',
                                dtype=ChannelType.DOUBLE,
                                doc='Intergral Gain')
    min_delta_t = pvproperty(name='MDT',
                             dtype=ChannelType.DOUBLE,
                             doc='Min Delta T')
    output_deadband = pvproperty(name='ODEL',
                                 dtype=ChannelType.DOUBLE,
                                 doc='Output Deadband')
    output_location = pvproperty(name='OUTL',
                                 dtype=ChannelType.STRING,
                                 doc='Output Location')
    ...
    proportional_gain = pvproperty(name='KP',
                                   dtype=ChannelType.DOUBLE,
                                   doc='Proportional Gain')
    readback_trigger = pvproperty(name='TRIG',
                                  dtype=ChannelType.STRING,
                                  doc='Readback Trigger')
    setpoint_location = pvproperty(name='STPL',
                                   dtype=ChannelType.STRING,
                                   doc='Setpoint Location')
    setpoint_mode_select = pvproperty(
        name='SMSL',
        dtype=ChannelType.ENUM,
        enum_strings=menus.menuOmsl.get_string_tuple(),
        doc='Setpoint Mode Select')
    trigger_value = pvproperty(name='TVAL',
                               dtype=ChannelType.DOUBLE,
                               doc='Trigger Value')
    _link_parent_attribute(display_precision, 'precision')
    _link_parent_attribute(high_operating_range, 'upper_ctrl_limit')
...
class GensubFields(RecordFieldGroup):
    ...
    alarm_status = pvproperty(
        ...
        doc='Alarm Status',
        read_only=True)
    old_subr_address = pvproperty(name='OSAD',
                                  dtype=ChannelType.LONG,
    ...
    old_return_value = pvproperty(name='OVAL',
                                  ...
                                  doc='Old return value',
                                  read_only=True)
    subroutine_address = pvproperty(name='SADR',
                                    dtype=ChannelType.LONG,
    ...
    display_precision = pvproperty(name='PREC',
                                   dtype=ChannelType.LONG,
                                   doc='Display Precision')
    version_number = pvproperty(name='VERS',
                                dtype=ChannelType.DOUBLE,
                                doc='Version Number',
                                read_only=True)
    ...
    input_link_u = pvproperty(name='INPU',
                              ...
                              doc='Input Link U',
                              read_only=True)
    subroutine_input_link = pvproperty(name='SUBL',
                                       dtype=ChannelType.STRING,
                                       doc='Subroutine Input Link',
                                       read_only=True)
    event_flag = pvproperty(name='EFLG',
                            dtype=ChannelType.ENUM,
                            enum_strings=menus.genSubEFLG.get_string_tuple(),
                            doc='Event Flag')
    link_flag = pvproperty(name='LFLG',
                           dtype=ChannelType.ENUM,
    ...
    init_routine_name = pvproperty(name='INAM',
                                   ...
                                   read_only=True)
    input_structure_a = pvproperty(name='UFA',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure A',
                                   read_only=True)
    input_structure_b = pvproperty(name='UFB',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure B',
                                   read_only=True)
    input_structure_c = pvproperty(name='UFC',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure C',
                                   read_only=True)
    input_structure_d = pvproperty(name='UFD',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure D',
                                   read_only=True)
    input_structure_e = pvproperty(name='UFE',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure E',
                                   read_only=True)
    input_structure_f = pvproperty(name='UFF',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure F',
                                   read_only=True)
    input_structure_g = pvproperty(name='UFG',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure G',
                                   read_only=True)
    input_structure_h = pvproperty(name='UFH',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure H',
                                   read_only=True)
    input_structure_i = pvproperty(name='UFI',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure I',
                                   read_only=True)
    input_structure_j = pvproperty(name='UFJ',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure J',
                                   read_only=True)
    input_structure_k = pvproperty(name='UFK',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure K',
                                   read_only=True)
    input_structure_l = pvproperty(name='UFL',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure L',
                                   read_only=True)
    input_structure_m = pvproperty(name='UFM',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure M',
                                   read_only=True)
    input_structure_n = pvproperty(name='UFN',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure N',
                                   read_only=True)
    input_structure_o = pvproperty(name='UFO',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure O',
                                   read_only=True)
    input_structure_p = pvproperty(name='UFP',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure P',
                                   read_only=True)
    input_structure_q = pvproperty(name='UFQ',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure Q',
                                   read_only=True)
    input_structure_r = pvproperty(name='UFR',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure R',
                                   read_only=True)
    input_structure_s = pvproperty(name='UFS',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure S',
                                   read_only=True)
    input_structure_t = pvproperty(name='UFT',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
                                   doc='Input Structure T',
                                   read_only=True)
    input_structure_u = pvproperty(name='UFU',
                                   dtype=ChannelType.CHAR,
                                   max_length=40,
    ...
    old_subroutine_name = pvproperty(name='ONAM',
                                     ...
                                     read_only=True)
    output_structure_a = pvproperty(name='UFVA',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure A',
                                    read_only=True)
    output_structure_b = pvproperty(name='UFVB',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure B',
                                    read_only=True)
    output_structure_c = pvproperty(name='UFVC',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure C',
                                    read_only=True)
    output_structure_d = pvproperty(name='UFVD',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure D',
                                    read_only=True)
    output_structure_e = pvproperty(name='UFVE',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure E',
                                    read_only=True)
    output_structure_f = pvproperty(name='UFVF',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure F',
                                    read_only=True)
    output_structure_g = pvproperty(name='UFVG',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure G',
                                    read_only=True)
    output_structure_h = pvproperty(name='UFVH',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure H',
                                    read_only=True)
    output_structure_i = pvproperty(name='UFVI',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure I',
                                    read_only=True)
    output_structure_j = pvproperty(name='UFVJ',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure J',
                                    read_only=True)
    output_structure_k = pvproperty(name='UFVK',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure K',
                                    read_only=True)
    output_structure_l = pvproperty(name='UFVL',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure L',
                                    read_only=True)
    output_structure_m = pvproperty(name='UFVM',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure M',
                                    read_only=True)
    output_structure_n = pvproperty(name='UFVN',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure N',
                                    read_only=True)
    output_structure_o = pvproperty(name='UFVO',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure O',
                                    read_only=True)
    output_structure_p = pvproperty(name='UFVP',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure P',
                                    read_only=True)
    output_structure_q = pvproperty(name='UFVQ',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure Q',
                                    read_only=True)
    output_structure_r = pvproperty(name='UFVR',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure R',
                                    read_only=True)
    output_structure_s = pvproperty(name='UFVS',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure S',
                                    read_only=True)
    output_structure_t = pvproperty(name='UFVT',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
                                    doc='Output Structure T',
                                    read_only=True)
    output_structure_u = pvproperty(name='UFVU',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
    ...
    process_subr_name = pvproperty(name='SNAM',
                                   ...
                                   max_length=40,
                                   doc='Process Subr. Name')
    no_in_a = pvproperty(name='NOA',
                         dtype=ChannelType.LONG,
                         doc='No. in A',
                         read_only=True)
    no_in_b = pvproperty(name='NOB',
                         dtype=ChannelType.LONG,
                         doc='No. in B',
                         read_only=True)
    no_in_c = pvproperty(name='NOC',
                         dtype=ChannelType.LONG,
                         doc='No. in C',
                         read_only=True)
    no_in_d = pvproperty(name='NOD',
                         dtype=ChannelType.LONG,
                         doc='No. in D',
                         read_only=True)
    no_in_e = pvproperty(name='NOE',
                         dtype=ChannelType.LONG,
                         doc='No. in E',
                         read_only=True)
    no_in_f = pvproperty(name='NOF',
                         dtype=ChannelType.LONG,
                         doc='No. in F',
                         read_only=True)
    no_in_g = pvproperty(name='NOG',
                         dtype=ChannelType.LONG,
                         doc='No. in G',
                         read_only=True)
    no_in_h = pvproperty(name='NOH',
                         dtype=ChannelType.LONG,
                         doc='No. in H',
                         read_only=True)
    no_in_i = pvproperty(name='NOI',
                         dtype=ChannelType.LONG,
                         doc='No. in I',
                         read_only=True)
    no_in_j = pvproperty(name='NOJ',
                         dtype=ChannelType.LONG,
                         doc='No. in J',
                         read_only=True)
    no_in_k = pvproperty(name='NOK',
                         dtype=ChannelType.LONG,
                         doc='No. in K',
                         read_only=True)
    no_in_l = pvproperty(name='NOL',
                         dtype=ChannelType.LONG,
                         doc='No. in L',
                         read_only=True)
    no_in_m = pvproperty(name='NOM',
                         dtype=ChannelType.LONG,
                         doc='No. in M',
                         read_only=True)
    no_in_n = pvproperty(name='NON',
                         dtype=ChannelType.LONG,
                         doc='No. in N',
                         read_only=True)
    no_in_o = pvproperty(name='NOO',
                         dtype=ChannelType.LONG,
                         doc='No. in O',
                         read_only=True)
    no_in_p = pvproperty(name='NOP',
                         dtype=ChannelType.LONG,
                         doc='No. in P',
                         read_only=True)
    no_in_q = pvproperty(name='NOQ',
                         dtype=ChannelType.LONG,
                         doc='No. in Q',
                         read_only=True)
    no_in_r = pvproperty(name='NOR',
                         dtype=ChannelType.LONG,
                         doc='No. in R',
                         read_only=True)
    no_in_s = pvproperty(name='NOS',
                         dtype=ChannelType.LONG,
                         doc='No. in S',
                         read_only=True)
    no_in_t = pvproperty(name='NOT',
                         dtype=ChannelType.LONG,
                         doc='No. in T',
                         read_only=True)
    no_in_u = pvproperty(name='NOU',
                         dtype=ChannelType.LONG,
                         doc='No. in U',
                         read_only=True)
    no_in_vala = pvproperty(name='NOVA',
                            dtype=ChannelType.LONG,
                            doc='No. in VALA',
                            read_only=True)
    no_in_valb = pvproperty(name='NOVB',
                            dtype=ChannelType.LONG,
                            doc='No. in VALB',
                            read_only=True)
    no_in_valc = pvproperty(name='NOVC',
                            dtype=ChannelType.LONG,
                            doc='No. in VALC',
                            read_only=True)
    no_in_vald = pvproperty(name='NOVD',
                            dtype=ChannelType.LONG,
                            doc='No. in VALD',
                            read_only=True)
    no_in_vale = pvproperty(name='NOVE',
                            dtype=ChannelType.LONG,
                            doc='No. in VALE',
                            read_only=True)
    no_in_valf = pvproperty(name='NOVF',
                            dtype=ChannelType.LONG,
                            doc='No. in VALF',
                            read_only=True)
    no_in_valg = pvproperty(name='NOVG',
                            dtype=ChannelType.LONG,
                            doc='No. in VALG',
                            read_only=True)
    no_in_vali = pvproperty(name='NOVI',
                            dtype=ChannelType.LONG,
                            doc='No. in VALI',
                            read_only=True)
    no_in_valj = pvproperty(name='NOVJ',
                            dtype=ChannelType.LONG,
                            doc='No. in VALJ',
                            read_only=True)
    no_in_valk = pvproperty(name='NOVK',
                            dtype=ChannelType.LONG,
                            doc='No. in VALK',
                            read_only=True)
    no_in_vall = pvproperty(name='NOVL',
                            dtype=ChannelType.LONG,
                            doc='No. in VALL',
                            read_only=True)
    no_in_valm = pvproperty(name='NOVM',
                            dtype=ChannelType.LONG,
                            doc='No. in VALM',
                            read_only=True)
    no_in_valn = pvproperty(name='NOVN',
                            dtype=ChannelType.LONG,
                            doc='No. in VALN',
                            read_only=True)
    no_in_valo = pvproperty(name='NOVO',
                            dtype=ChannelType.LONG,
                            doc='No. in VALO',
                            read_only=True)
    no_in_valp = pvproperty(name='NOVP',
                            dtype=ChannelType.LONG,
                            doc='No. in VALP',
                            read_only=True)
    no_in_valq = pvproperty(name='NOVQ',
                            dtype=ChannelType.LONG,
                            doc='No. in VALQ',
                            read_only=True)
    no_in_valr = pvproperty(name='NOVR',
                            dtype=ChannelType.LONG,
                            doc='No. in VALR',
                            read_only=True)
    no_in_vals = pvproperty(name='NOVS',
                            dtype=ChannelType.LONG,
                            doc='No. in VALS',
                            read_only=True)
    no_in_valt = pvproperty(name='NOVT',
                            dtype=ChannelType.LONG,
                            doc='No. in VALT',
                            read_only=True)
    no_in_valu = pvproperty(name='NOVU',
                            dtype=ChannelType.LONG,
                            doc='No. in VALU',
                            read_only=True)
    no_in_valh = pvproperty(name='NOVH',
                            dtype=ChannelType.LONG,
                            doc='No. in VAlH',
                            read_only=True)
    total_bytes_for_vala = pvproperty(name='TOVA',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALA',
                                      read_only=True)
    total_bytes_for_valb = pvproperty(name='TOVB',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALB',
                                      read_only=True)
    total_bytes_for_valc = pvproperty(name='TOVC',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALC',
                                      read_only=True)
    total_bytes_for_vald = pvproperty(name='TOVD',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALD',
                                      read_only=True)
    total_bytes_for_vale = pvproperty(name='TOVE',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALE',
                                      read_only=True)
    total_bytes_for_valf = pvproperty(name='TOVF',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALF',
                                      read_only=True)
    total_bytes_for_valg = pvproperty(name='TOVG',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALG',
                                      read_only=True)
    total_bytes_for_vali = pvproperty(name='TOVI',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALI',
                                      read_only=True)
    total_bytes_for_valj = pvproperty(name='TOVJ',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALJ',
                                      read_only=True)
    total_bytes_for_valk = pvproperty(name='TOVK',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALK',
                                      read_only=True)
    total_bytes_for_vall = pvproperty(name='TOVL',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALL',
                                      read_only=True)
    total_bytes_for_valm = pvproperty(name='TOVM',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALM',
                                      read_only=True)
    total_bytes_for_valn = pvproperty(name='TOVN',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALN',
                                      read_only=True)
    total_bytes_for_valo = pvproperty(name='TOVO',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALO',
                                      read_only=True)
    total_bytes_for_valp = pvproperty(name='TOVP',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALP',
                                      read_only=True)
    total_bytes_for_valq = pvproperty(name='TOVQ',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALQ',
                                      read_only=True)
    total_bytes_for_valr = pvproperty(name='TOVR',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALR',
                                      read_only=True)
    total_bytes_for_vals = pvproperty(name='TOVS',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALS',
                                      read_only=True)
    total_bytes_for_valt = pvproperty(name='TOVT',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALT',
                                      read_only=True)
    total_bytes_for_valu = pvproperty(name='TOVU',
                                      dtype=ChannelType.LONG,
                                      doc='Total bytes for VALU',
                                      read_only=True)
    total_bytes_for_valh = pvproperty(name='TOVH',
                                      dtype=ChannelType.LONG,
...
class MbbiFields(RecordFieldGroup):
    ...
    input_specification = pvproperty(name='INP',
                                     dtype=ChannelType.STRING,
                                     doc='Input Specification')
    sim_input_specification = pvproperty(name='SIOL',
                                         dtype=ChannelType.STRING,
                                         doc='Sim Input Specifctn')
    simulation_value = pvproperty(name='SVAL',
                                  dtype=ChannelType.LONG,
...
class MbboFields(RecordFieldGroup):
    ...
    readback_value = pvproperty(name='RBV',
                                ...
                                doc='Readback Value',
                                read_only=True)
    desired_output_location = pvproperty(name='DOL',
                                         dtype=ChannelType.STRING,
                                         doc='Desired Output Loc')
    invalid_outpt_action = pvproperty(
        name='IVOA',
    ...
    output_specification = pvproperty(name='OUT',
                                      dtype=ChannelType.STRING,
                                      doc='Output Specification')
    sim_output_specification = pvproperty(name='SIOL',
                                          dtype=ChannelType.STRING,
                                          doc='Sim Output Specifctn')
...
class MotorFields(RecordFieldGroup):
    ...
    code_version = pvproperty(name='VERS',
                              ...
                              doc='Code Version',
                              read_only=True)
    dial_desired_value_egu = pvproperty(name='DVAL',
                                        dtype=ChannelType.DOUBLE,
    ...
    last_dial_des_val_egu = pvproperty(name='LDVL',
                                       dtype=ChannelType.DOUBLE,
                                       doc='Last Dial Des Val (EGU)',
                                       read_only=True)
    last_raw_des_val_steps = pvproperty(name='LRVL',
                                        dtype=ChannelType.LONG,
                                        doc='Last Raw Des Val (steps',
                                        read_only=True)
    last_rel_value_egu = pvproperty(name='LRLV',
                                    dtype=ChannelType.DOUBLE,
    ...
    last_spmg = pvproperty(name='LSPG',
                           ...
                           doc='Last SPMG',
                           read_only=True)
    last_user_des_val_egu = pvproperty(name='LVAL',
                                       dtype=ChannelType.DOUBLE,
    ...
    ran_out_of_retries = pvproperty(name='MISS',
                                    ...
                                    read_only=True)
    raw_desired_value_step = pvproperty(name='RVAL',
                                        dtype=ChannelType.LONG,
    ...
    raw_readback_value = pvproperty(name='RRBV',
                                    ...
                                    read_only=True)
    raw_command_direction = pvproperty(name='CDIR',
                                       dtype=ChannelType.LONG,
                                       doc='Raw cmnd direction',
                                       read_only=True)
    relative_value_egu = pvproperty(name='RLV',
                                    dtype=ChannelType.DOUBLE,
    ...
    archive_deadband = pvproperty(name='ADEL',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Archive Deadband')
    bl_distance_egu = pvproperty(name='BDST',
                                 dtype=ChannelType.DOUBLE,
                                 doc='BL Distance (EGU)')
    bl_seconds_to_velocity = pvproperty(name='BACC',
                                        dtype=ChannelType.DOUBLE,
                                        doc='BL Seconds to Velocity')
    bl_speed_rps = pvproperty(name='SBAK',
                              dtype=ChannelType.DOUBLE,
                              doc='BL Speed (RPS)')
    bl_velocity_egu_s = pvproperty(name='BVEL',
                                   dtype=ChannelType.DOUBLE,
                                   doc='BL Velocity (EGU/s)')
    base_speed_rps = pvproperty(name='SBAS',
                                dtype=ChannelType.DOUBLE,
                                doc='Base Speed (RPS)')
    base_velocity_egu_s = pvproperty(name='VBAS',
                                     dtype=ChannelType.DOUBLE,
    ...
    enable_control = pvproperty(
        ...
        doc='Enable control')
    encoder_step_size_egu = pvproperty(name='ERES',
                                       dtype=ChannelType.DOUBLE,
    ...
    high_alarm_limit_egu = pvproperty(name='HIGH',
                                      dtype=ChannelType.DOUBLE,
                                      doc='High Alarm Limit (EGU)')
    high_operating_range = pvproperty(name='HOPR',
                                      dtype=ChannelType.DOUBLE,
                                      doc='High Operating Range')
    high_severity = pvproperty(
        ...
        enum_strings=menus.menuAlarmSevr.get_string_tuple(),
        doc='High Severity')
    hihi_alarm_limit_egu = pvproperty(name='HIHI',
                                      dtype=ChannelType.DOUBLE,
                                      doc='Hihi Alarm Limit (EGU)')
    hihi_severity = pvproperty(
        name='HHSV',
        dtype=ChannelType.ENUM,
        enum_strings=menus.menuAlarmSevr.get_string_tuple(),
        doc='Hihi Severity')
    home_velocity_egu_s = pvproperty(name='HVEL',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Home Velocity (EGU/s)')
    integral_gain = pvproperty(name='ICOF',
                               dtype=ChannelType.DOUBLE,
                               doc='Integral Gain')
    jog_accel_egu_s_2 = pvproperty(name='JAR',
                                   dtype=ChannelType.DOUBLE,
                                   doc='Jog Accel. (EGU/s^2)')
    jog_velocity_egu_s = pvproperty(name='JVEL',
                                    dtype=ChannelType.DOUBLE,
                                    doc='Jog Velocity (EGU/s)')
    lolo_alarm_limit_egu = pvproperty(name='LOLO',
                                      dtype=ChannelType.DOUBLE,
                                      doc='Lolo Alarm Limit (EGU)')
    lolo_severity = pvproperty(
        name='LLSV',
        dtype=ChannelType.ENUM,
        enum_strings=menus.menuAlarmSevr.get_string_tuple(),
        doc='Lolo Severity')
    low_alarm_limit_egu = pvproperty(name='LOW',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Low Alarm Limit (EGU)')
    low_operating_range = pvproperty(name='LOPR',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Low Operating Range')
    low_severity = pvproperty(
    ...
    max_retry_count = pvproperty(name='RTRY',
                                 dtype=ChannelType.LONG,
                                 doc='Max retry count')
    max_speed_rps = pvproperty(name='SMAX',
                               dtype=ChannelType.DOUBLE,
                               doc='Max. Speed (RPS)')
    max_velocity_egu_s = pvproperty(name='VMAX',
                                    dtype=ChannelType.DOUBLE,
                                    doc='Max. Velocity (EGU/s)')
    monitor_deadband = pvproperty(name='MDEL',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Monitor Deadband')
    motor_step_size_egu = pvproperty(name='MRES',
                                     dtype=ChannelType.DOUBLE,
    ...
    readback_step_size_egu = pvproperty(name='RRES',
                                        dtype=ChannelType.DOUBLE,
                                        doc='Readback Step Size (EGU')
    readback_settle_time_s = pvproperty(name='DLY',
                                        dtype=ChannelType.DOUBLE,
                                        doc='Readback settle time (s)')
    retry_deadband_egu = pvproperty(name='RDBD',
                                    dtype=ChannelType.DOUBLE,
    ...
    speed_revolutions_sec = pvproperty(name='S',
                                       dtype=ChannelType.DOUBLE,
    ...
    tweak_step_size_egu = pvproperty(name='TWV',
                                     dtype=ChannelType.DOUBLE,
    ...
    user_direction = pvproperty(name='DIR',
                                ...
                                doc='User Direction')
    velocity_egu_s = pvproperty(name='VELO',
                                dtype=ChannelType.DOUBLE,
                                doc='Velocity (EGU/s)')
    _link_parent_attribute(display_precision, 'precision')
    _link_parent_attribute(high_operating_range, 'upper_ctrl_limit')
...
class PermissiveFields(RecordFieldGroup):
    ...
    old_status = pvproperty(name='OVAL',
                            ...
                            doc='Old Status',
                            read_only=True)
    wait_flag = pvproperty(name='WFLG',
                           dtype=ChannelType.LONG,
                           doc='Wait Flag')
...
class ScalcoutFields(RecordFieldGroup):
    ...
    output_value = pvproperty(name='OVAL',
                              dtype=ChannelType.DOUBLE,
                              doc='Output Value')
    output_string_value = pvproperty(name='OSV',
                                     dtype=ChannelType.CHAR,
                                     max_length=40,
                                     doc='Output string value')
    previous_ovalue = pvproperty(name='POVL',
                                 dtype=ChannelType.DOUBLE,
                                 doc='Prev Value of OVAL')
    previous_value = pvproperty(name='PVAL',
                                dtype=ChannelType.DOUBLE,
    ...
    previous_output_string_value = pvproperty(
        ...
        read_only=True)
    previous_string_result = pvproperty(name='PSVL',
                                        dtype=ChannelType.CHAR,
                                        max_length=40,
                                        doc='Previous string result',
                                        read_only=True)
    string_result = pvproperty(name='SVAL',
                               dtype=ChannelType.CHAR,
                               max_length=40,
                               doc='String result')
    wait_for_completion = pvproperty(
    ...
    display_precision = pvproperty(name='PREC',
                                   dtype=ChannelType.LONG,
                                   doc='Display Precision')
    high_operating_rng = pvproperty(name='HOPR',
                                    dtype=ChannelType.DOUBLE,
                                    doc='High Operating Rng')
    low_operating_range = pvproperty(name='LOPR',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Low Operating Range')
    monitor_deadband = pvproperty(name='MDEL',
...
class ScanparmFields(RecordFieldGroup):
    ...
    code_version = pvproperty(name='VERS',
                              ...
                              doc='Code Version',
                              read_only=True)
    last_stepsize = pvproperty(name='LSTP',
                               dtype=ChannelType.DOUBLE,
                               doc='Last stepSize',
                               read_only=True)
    maxpts = pvproperty(name='MP',
                        dtype=ChannelType.LONG,
                        doc='MaxPts',
                        read_only=True)
    scanactive = pvproperty(name='ACT',
                            dtype=ChannelType.LONG,
                            doc='ScanActive',
                            read_only=True)
    stepsize = pvproperty(name='STEP',
                          dtype=ChannelType.DOUBLE,
                          doc='StepSize',
                          read_only=True)
    after_outlink = pvproperty(name='OAFT',
                               dtype=ChannelType.STRING,
                               doc='AFT OutLink',
                               read_only=True)
    acquire_time_outlink = pvproperty(name='OAQT',
                                      dtype=ChannelType.STRING,
                                      doc='AQT OutLink',
                                      read_only=True)
    ar_outlink = pvproperty(name='OAR',
                            dtype=ChannelType.STRING,
                            doc='AR OutLink',
                            read_only=True)
    after = pvproperty(name='AFT',
                       dtype=ChannelType.ENUM,
                       enum_strings=menus.sscanPASM.get_string_tuple(),
                       doc='After')
    d1pv_outlink = pvproperty(name='ODPV',
                              dtype=ChannelType.STRING,
                              doc='D1PV OutLink',
                              read_only=True)
    detpvname = pvproperty(name='DPV',
                           dtype=ChannelType.CHAR,
                           max_length=40,
                           doc='DetPVName')
    ep_outlink = pvproperty(name='OEP',
                            dtype=ChannelType.STRING,
                            doc='EP OutLink',
                            read_only=True)
    go_outlink = pvproperty(name='OGO',
                            dtype=ChannelType.STRING,
                            doc='GO OutLink',
                            read_only=True)
    inlink = pvproperty(name='IACT',
                        dtype=ChannelType.STRING,
                        doc='InLink',
                        read_only=True)
    load_outlink = pvproperty(name='OLOAD',
                              dtype=ChannelType.STRING,
                              doc='LOAD OutLink',
                              read_only=True)
    mp_inlink = pvproperty(name='IMP',
                           dtype=ChannelType.STRING,
                           doc='MP InLink',
                           read_only=True)
    np_outlink = pvproperty(name='ONP',
                            dtype=ChannelType.STRING,
                            doc='NP OutLink',
                            read_only=True)
    p1pv_outlink = pvproperty(name='OPPV',
                              dtype=ChannelType.STRING,
                              doc='P1PV OutLink',
                              read_only=True)
    pre_write_outlink = pvproperty(name='OPRE',
                                   dtype=ChannelType.STRING,
                                   doc='PRE-write OutLink',
                                   read_only=True)
    positionerpvname = pvproperty(name='PPV',
                                  dtype=ChannelType.CHAR,
                                  max_length=40,
                                  doc='PositionerPVName')
    r1pv_outlink = pvproperty(name='ORPV',
                              dtype=ChannelType.STRING,
                              doc='R1PV OutLink',
                              read_only=True)
    readbackpvname = pvproperty(name='RPV',
                                dtype=ChannelType.CHAR,
                                max_length=40,
                                doc='ReadbackPVName')
    sc_outlink = pvproperty(name='OSC',
                            dtype=ChannelType.STRING,
                            doc='SC OutLink',
                            read_only=True)
    sm_outlink = pvproperty(name='OSM',
                            dtype=ChannelType.STRING,
                            doc='SM OutLink',
                            read_only=True)
    sp_outlink = pvproperty(name='OSP',
                            dtype=ChannelType.STRING,
                            doc='SP OutLink',
                            read_only=True)
    stepmode = pvproperty(name='SM',
                          dtype=ChannelType.ENUM,
                          enum_strings=menus.sscanP1SM.get_string_tuple(),
                          doc='StepMode')
    t1pv_outlink = pvproperty(name='OTPV',
                              dtype=ChannelType.STRING,
                              doc='T1PV OutLink',
                              read_only=True)
    trigpvname = pvproperty(name='TPV',
                            dtype=ChannelType.CHAR,
                            max_length=40,
                            doc='TrigPVName')
    absrel = pvproperty(name='AR',
                        dtype=ChannelType.ENUM,
                        enum_strings=menus.sscanP1AR.get_string_tuple(),
                        doc='absRel')
    acquire_time = pvproperty(name='AQT',
                              dtype=ChannelType.DOUBLE,
                              doc='Acquire time')
    display_precision = pvproperty(name='PREC',
                                   dtype=ChannelType.LONG,
    ...
    pre_write_command = pvproperty(name='PRE',
                                   dtype=ChannelType.LONG,
                                   doc='PRE-write command')
...
class SeqFields(RecordFieldGroup):
    ...
    alarm_status = pvproperty(
        ...
        doc='Alarm Status',
        read_only=True)
    constant_input_1 = pvproperty(name='DO1',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Constant input 1')
    constant_input_10 = pvproperty(name='DOA',
                                   dtype=ChannelType.DOUBLE,
                                   doc='Constant input 10')
    constant_input_2 = pvproperty(name='DO2',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Constant input 2')
    constant_input_3 = pvproperty(name='DO3',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Constant input 3')
    constant_input_4 = pvproperty(name='DO4',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Constant input 4')
    constant_input_5 = pvproperty(name='DO5',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Constant input 5')
    constant_input_6 = pvproperty(name='DO6',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Constant input 6')
    constant_input_7 = pvproperty(name='DO7',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Constant input 7')
    constant_input_8 = pvproperty(name='DO8',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Constant input 8')
    constant_input_9 = pvproperty(name='DO9',
                                  dtype=ChannelType.DOUBLE,
                                  doc='Constant input 9')
    link_selection = pvproperty(name='SELN',
                                dtype=ChannelType.LONG,
                                doc='Link Selection')
    display_precision = pvproperty(name='PREC',
...
class SscanFields(RecordFieldGroup):
    ...
    a1_pv_status = pvproperty(name='A1NV',
                              dtype=ChannelType.ENUM,
                              enum_strings=menus.sscanP1NV.get_string_tuple(),
                              doc='A1  PV Status',
                              read_only=True)
    abort_right_now = pvproperty(name='KILL',
                                 dtype=ChannelType.CHAR,
                                 doc='Abort right now',
                                 read_only=True)
    ...
    alarm_status = pvproperty(
        ...
        doc='Alarm Status',
        read_only=True)
    auto_wait_count = pvproperty(name='AWCT',
                                 dtype=ChannelType.LONG,
                                 doc='Auto WCNT')
    beforescan_pv_status = pvproperty(
        ...
        read_only=True)
    buffered_current_point = pvproperty(name='BCPT',
                                        dtype=ChannelType.LONG,
    ...
    code_version = pvproperty(name='VERS',
                              ...
                              doc='Code Version',
                              read_only=True)
    command_field = pvproperty(name='CMND',
                               dtype=ChannelType.ENUM,
                               enum_strings=menus.sscanCMND.get_string_tuple(),
                               doc='Command Field')
    current_point = pvproperty(name='CPT',
                               dtype=ChannelType.LONG,
                               doc='Current Point',
                               read_only=True)
    desired_point = pvproperty(name='DPT',
                               dtype=ChannelType.LONG,
                               doc='Desired Point')
    execute_scan = pvproperty(name='EXSC',
                              dtype=ChannelType.LONG,
                              doc='Execute Scan')
    ...
    internal_execscan = pvproperty(name='XSC',
                                   dtype=ChannelType.LONG,
    ...
    last_value_of_go_pause = pvproperty(
        ...
        read_only=True)
    operator_alert = pvproperty(name='ALRT',
                                dtype=ChannelType.CHAR,
                                doc='Operator Alert',
                                read_only=True)
    point_oflast_posting = pvproperty(name='PCPT',
                                      dtype=ChannelType.LONG,
                                      doc='Point ofLast Posting',
                                      read_only=True)
    previous_xscan = pvproperty(name='PXSC',
                                dtype=ChannelType.CHAR,
                                doc='Previous XScan',
                                read_only=True)
    record_state_msg = pvproperty(name='SMSG',
                                  dtype=ChannelType.CHAR,
                                  max_length=40,
                                  doc='Record State Msg')
    reference_detector = pvproperty(name='REFD',
                                    dtype=ChannelType.LONG,
                                    doc='Reference detector')
    scan_data_ready = pvproperty(name='DATA',
                                 dtype=ChannelType.LONG,
                                 doc='Scan data ready',
                                 read_only=True)
    scan_in_progress = pvproperty(name='BUSY',
                                  dtype=ChannelType.CHAR,
                                  doc='Scan in progress',
                                  read_only=True)
    scan_phase = pvproperty(name='FAZE',
                            dtype=ChannelType.ENUM,
                            enum_strings=menus.sscanFAZE.get_string_tuple(),
                            doc='Scan phase',
                            read_only=True)
    wait_count = pvproperty(name='WCNT',
                            dtype=ChannelType.LONG,
                            doc='Wait count)',
                            read_only=True)
    wait_for_client_s = pvproperty(name='WAIT',
                                   dtype=ChannelType.LONG,
                                   doc='Wait for client(s)')
    waiting_for_client_s = pvproperty(name='WTNG',
                                      dtype=ChannelType.LONG,
    ...
    after_scan_pv_name = pvproperty(name='ASPV',
                                    dtype=ChannelType.CHAR,
                                    max_length=40,
    ...
    before_scan_pv_name = pvproperty(name='BSPV',
                                     dtype=ChannelType.CHAR,
                                     max_length=40,
    ...
    copy_last_pt_thru = pvproperty(name='COPYTO',
                                   dtype=ChannelType.LONG,
                                   doc='Copy Last Pt Thru')
    data_state = pvproperty(name='DSTATE',
                            dtype=ChannelType.ENUM,
                            enum_strings=menus.sscanDSTATE.get_string_tuple(),
                            doc='Data state',
                            read_only=True)
    a1_command = pvproperty(name='A1CD',
                            dtype=ChannelType.DOUBLE,
                            doc='A1 Cmnd')
    after_scan_command = pvproperty(name='ASCD',
                                    dtype=ChannelType.DOUBLE,
                                    doc='After Scan Cmnd')
    array_post_time_period = pvproperty(name='ATIME',
                                        dtype=ChannelType.DOUBLE,
                                        doc='Array post time period')
    ...
    before_scan_command = pvproperty(name='BSCD',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Before Scan Cmnd')
    detector_settling_delay = pvproperty(name='DDLY',
                                         dtype=ChannelType.DOUBLE,
                                         doc='Detector-settling delay')
    pause_resume_delay = pvproperty(name='RDLY',
                                    dtype=ChannelType.DOUBLE,
                                    doc='Pause resume delay')
    positioner_settling_delay = pvproperty(name='PDLY',
                                           dtype=ChannelType.DOUBLE,
                                           doc='Positioner-settling delay')
    wait_for_completion = pvproperty(
        name='ASWAIT',
        dtype=ChannelType.ENUM,
    ...
    wait_for_completion_bswait = pvproperty(
        ...
        enum_strings=menus.sscanLINKWAIT.get_string_tuple(),
        doc='Wait for completion?')
    max_of_points = pvproperty(name='MPTS',
                               dtype=ChannelType.LONG,
                               doc='Max # of Points',
                               read_only=True)
    number_of_points = pvproperty(name='NPTS',
                                  dtype=ChannelType.LONG,
...
class SseqFields(RecordFieldGroup):
    ...
    abort_sequence = pvproperty(name='ABORT',
                                dtype=ChannelType.LONG,
                                doc='Abort sequence')
    aborting = pvproperty(name='ABORTING',
                          dtype=ChannelType.LONG,
                          doc='Aborting')
    alarm_status = pvproperty(
        name='STAT',
    ...
    dol_link_status_dolav = pvproperty(
        ...
        doc='DOL LINK Status',
        read_only=True)
    dol_link_type = pvproperty(name='DT1',
                               dtype=ChannelType.LONG,
                               doc='DOL link type',
                               read_only=True)
    dol_link_type_dt2 = pvproperty(name='DT2',
                                   dtype=ChannelType.LONG,
                                   doc='DOL link type',
                                   read_only=True)
    dol_link_type_dt3 = pvproperty(name='DT3',
                                   dtype=ChannelType.LONG,
                                   doc='DOL link type',
                                   read_only=True)
    dol_link_type_dt4 = pvproperty(name='DT4',
                                   dtype=ChannelType.LONG,
                                   doc='DOL link type',
                                   read_only=True)
    dol_link_type_dt5 = pvproperty(name='DT5',
                                   dtype=ChannelType.LONG,
                                   doc='DOL link type',
                                   read_only=True)
    dol_link_type_dt6 = pvproperty(name='DT6',
                                   dtype=ChannelType.LONG,
                                   doc='DOL link type',
                                   read_only=True)
    dol_link_type_dt7 = pvproperty(name='DT7',
                                   dtype=ChannelType.LONG,
                                   doc='DOL link type',
                                   read_only=True)
    dol_link_type_dt8 = pvproperty(name='DT8',
                                   dtype=ChannelType.LONG,
                                   doc='DOL link type',
                                   read_only=True)
    dol_link_type_dt9 = pvproperty(name='DT9',
                                   dtype=ChannelType.LONG,
                                   doc='DOL link type',
                                   read_only=True)
    dol_link_type_dta = pvproperty(name='DTA',
                                   dtype=ChannelType.LONG,
                                   doc='DOL link type',
                                   read_only=True)
    ...
    lnk_link_status_lnkav = pvproperty(
        ...
        doc='LNK LINK Status',
        read_only=True)
    lnk_link_type = pvproperty(name='LT1',
                               dtype=ChannelType.LONG,
                               doc='LNK link type',
                               read_only=True)
    lnk_link_type_lt2 = pvproperty(name='LT2',
                                   dtype=ChannelType.LONG,
                                   doc='LNK link type',
                                   read_only=True)
    lnk_link_type_lt3 = pvproperty(name='LT3',
                                   dtype=ChannelType.LONG,
                                   doc='LNK link type',
                                   read_only=True)
    lnk_link_type_lt4 = pvproperty(name='LT4',
                                   dtype=ChannelType.LONG,
                                   doc='LNK link type',
                                   read_only=True)
    lnk_link_type_lt5 = pvproperty(name='LT5',
                                   dtype=ChannelType.LONG,
                                   doc='LNK link type',
                                   read_only=True)
    lnk_link_type_lt6 = pvproperty(name='LT6',
                                   dtype=ChannelType.LONG,
                                   doc='LNK link type',
                                   read_only=True)
    lnk_link_type_lt7 = pvproperty(name='LT7',
                                   dtype=ChannelType.LONG,
                                   doc='LNK link type',
                                   read_only=True)
    lnk_link_type_lt8 = pvproperty(name='LT8',
                                   dtype=ChannelType.LONG,
                                   doc='LNK link type',
                                   read_only=True)
    lnk_link_type_lt9 = pvproperty(name='LT9',
                                   dtype=ChannelType.LONG,
                                   doc='LNK link type',
                                   read_only=True)
    lnk_link_type_lta = pvproperty(name='LTA',
                                   dtype=ChannelType.LONG,
                                   doc='LNK link type',
                                   read_only=True)
    link_selection = pvproperty(name='SELN',
                                dtype=ChannelType.LONG,
                                doc='Link Selection')
    sequence_active = pvproperty(name='BUSY',
                                 dtype=ChannelType.LONG,
                                 doc='Sequence active',
                                 read_only=True)
    display_precision = pvproperty(name='PREC',
    ...
    output_link_3 = pvproperty(name='LNK3',
                               dtype=ChannelType.STRING,
                               doc='Output Link 3')
    string_value_1 = pvproperty(name='STR1',
                                dtype=ChannelType.CHAR,
                                max_length=40,
                                doc='String value 1')
    string_value_2 = pvproperty(name='STR2',
                                dtype=ChannelType.CHAR,
                                max_length=40,
                                doc='String value 2')
    string_value_3 = pvproperty(name='STR3',
                                dtype=ChannelType.CHAR,
                                max_length=40,
                                doc='String value 3')
    string_value_4 = pvproperty(name='STR4',
                                dtype=ChannelType.CHAR,
                                max_length=40,
                                doc='String value 4')
    string_value_5 = pvproperty(name='STR5',
                                dtype=ChannelType.CHAR,
                                max_length=40,
                                doc='String value 5')
    string_value_6 = pvproperty(name='STR6',
                                dtype=ChannelType.CHAR,
                                max_length=40,
                                doc='String value 6')
    string_value_7 = pvproperty(name='STR7',
                                dtype=ChannelType.CHAR,
                                max_length=40,
                                doc='String value 7')
    string_value_8 = pvproperty(name='STR8',
                                dtype=ChannelType.CHAR,
                                max_length=40,
                                doc='String value 8')
    string_value_9 = pvproperty(name='STR9',
                                dtype=ChannelType.CHAR,
                                max_length=40,
                                doc='String value 9')
    string_value_a = pvproperty(name='STRA',
                                dtype=ChannelType.CHAR,
                                max_length=40,
                                doc='String value A')
    wait_for_completion = pvproperty(
...
class SwaitFields(RecordFieldGroup):
    ...
    code_version = pvproperty(name='VERS',
                              ...
                              doc='Code Version',
                              read_only=True)
    dol_pv_status = pvproperty(name='DOLV',
                               dtype=ChannelType.ENUM,
    ...
    last_value_archived = pvproperty(name='ALST',
                                     ...
                                     doc='Last Value Archived',
                                     read_only=True)
    out_pv_status = pvproperty(name='OUTV',
                               dtype=ChannelType.ENUM,
                               enum_strings=menus.swaitINAV.get_string_tuple(),
                               doc='OUT  PV Status',
                               read_only=True)
    old_value = pvproperty(name='OVAL',
                           dtype=ChannelType.DOUBLE,
                           doc='Old Value')
    simulation_mode = pvproperty(
        name='SIMM',
    ...
    low_operating_range = pvproperty(name='LOPR',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Low Operating Range')
    dol_pv_name = pvproperty(name='DOLN',
                             dtype=ChannelType.CHAR,
                             max_length=40,
                             doc='DOL  PV Name')
    out_pv_name = pvproperty(name='OUTN',
                             dtype=ChannelType.CHAR,
                             max_length=40,
                             doc='OUT  PV Name')
    ...
    calculation = pvproperty(name='CALC',
                             ...
                             max_length=36,
                             doc='Calculation')
    desired_output_data = pvproperty(name='DOLD',
                                     dtype=ChannelType.DOUBLE,
                                     doc='Desired Output Data')
    event_to_issue = pvproperty(name='OEVT',
                                dtype=ChannelType.LONG,
                                doc='Event To Issue')
    monitor_deadband = pvproperty(name='MDEL',
...
class TableFields(RecordFieldGroup):
    ...
    set_use_mode = pvproperty(name='SUSE',
                              dtype=ChannelType.LONG,
                              doc='Set USE Mode')
    encoder_0x_val = pvproperty(name='E0X',
                                dtype=ChannelType.DOUBLE,
                                doc='encoder 0X val',
                                read_only=True)
    encoder_0y_val = pvproperty(name='E0Y',
                                dtype=ChannelType.DOUBLE,
                                doc='encoder 0Y val',
                                read_only=True)
    encoder_1y_val = pvproperty(name='E1Y',
                                dtype=ChannelType.DOUBLE,
                                doc='encoder 1Y val',
                                read_only=True)
    encoder_2x_val = pvproperty(name='E2X',
                                dtype=ChannelType.DOUBLE,
                                doc='encoder 2X val',
                                read_only=True)
    encoder_2y_val = pvproperty(name='E2Y',
                                dtype=ChannelType.DOUBLE,
                                doc='encoder 2Y val',
                                read_only=True)
    encoder_2z_val = pvproperty(name='E2Z',
                                dtype=ChannelType.DOUBLE,
                                doc='encoder 2Z val',
                                read_only=True)
    encoder_x = pvproperty(name='EX',
                           dtype=ChannelType.DOUBLE,
                           doc='encoder x',
                           read_only=True)
    encoder_x_angle = pvproperty(name='EAX',
                                 dtype=ChannelType.DOUBLE,
                                 doc='encoder x angle',
                                 read_only=True)
    encoder_y = pvproperty(name='EY',
                           dtype=ChannelType.DOUBLE,
                           doc='encoder y',
                           read_only=True)
    encoder_y_angle = pvproperty(name='EAY',
                                 dtype=ChannelType.DOUBLE,
                                 doc='encoder y angle',
                                 read_only=True)
    encoder_z = pvproperty(name='EZ',
                           dtype=ChannelType.DOUBLE,
                           doc='encoder z',
                           read_only=True)
    encoder_z_angle = pvproperty(name='EAZ',
                                 dtype=ChannelType.DOUBLE,
                                 doc='encoder z angle',
                                 read_only=True)
    init_table = pvproperty(name='INIT',
                            dtype=ChannelType.LONG,
                            doc='init table')
    limit_violation = pvproperty(name='LVIO',
                                 dtype=ChannelType.LONG,
                                 doc='limit violation',
                                 read_only=True)
    motor_0x_hi_limit = pvproperty(name='H0X',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 0X hi limit',
                                   read_only=True)
    motor_0x_lo_limit = pvproperty(name='L0X',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 0X lo limit',
                                   read_only=True)
    motor_0x_readback = pvproperty(name='R0X',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 0X readback',
                                   read_only=True)
    motor_0x_val = pvproperty(name='M0X',
                              dtype=ChannelType.DOUBLE,
                              doc='motor 0X val',
                              read_only=True)
    motor_0y_hi_limit = pvproperty(name='H0Y',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 0Y hi limit',
                                   read_only=True)
    motor_0y_lo_limit = pvproperty(name='L0Y',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 0Y lo limit',
                                   read_only=True)
    motor_0y_readback = pvproperty(name='R0Y',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 0Y readback',
                                   read_only=True)
    motor_0y_val = pvproperty(name='M0Y',
                              dtype=ChannelType.DOUBLE,
                              doc='motor 0Y val',
                              read_only=True)
    motor_1y_hi_limit = pvproperty(name='H1Y',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 1Y hi limit',
                                   read_only=True)
    motor_1y_lo_limit = pvproperty(name='L1Y',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 1Y lo limit',
                                   read_only=True)
    motor_1y_readback = pvproperty(name='R1Y',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 1Y readback',
                                   read_only=True)
    motor_1y_val = pvproperty(name='M1Y',
                              dtype=ChannelType.DOUBLE,
                              doc='motor 1Y val',
                              read_only=True)
    motor_2x_hi_limit = pvproperty(name='H2X',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 2X hi limit',
                                   read_only=True)
    motor_2x_lo_limit = pvproperty(name='L2X',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 2X lo limit',
                                   read_only=True)
    motor_2x_readback = pvproperty(name='R2X',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 2X readback',
                                   read_only=True)
    motor_2x_val = pvproperty(name='M2X',
                              dtype=ChannelType.DOUBLE,
                              doc='motor 2X val',
                              read_only=True)
    motor_2y_hi_limit = pvproperty(name='H2Y',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 2Y hi limit',
                                   read_only=True)
    motor_2y_lo_limit = pvproperty(name='L2Y',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 2Y lo limit',
                                   read_only=True)
    motor_2y_readback = pvproperty(name='R2Y',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 2Y readback',
                                   read_only=True)
    motor_2y_val = pvproperty(name='M2Y',
                              dtype=ChannelType.DOUBLE,
                              doc='motor 2Y val',
                              read_only=True)
    motor_2z_hi_limit = pvproperty(name='H2Z',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 2Z hi limit',
                                   read_only=True)
    motor_2z_lo_limit = pvproperty(name='L2Z',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 2Z lo limit',
                                   read_only=True)
    motor_2z_readback = pvproperty(name='R2Z',
                                   dtype=ChannelType.DOUBLE,
                                   doc='motor 2Z readback',
                                   read_only=True)
    motor_2z_val = pvproperty(name='M2Z',
                              dtype=ChannelType.DOUBLE,
                              doc='motor 2Z val',
                              read_only=True)
    readback_motors = pvproperty(name='READ',
                                 dtype=ChannelType.LONG,
                                 doc='readback motors')
    set_table = pvproperty(name='SET',
                           dtype=ChannelType.ENUM,
                           enum_strings=menus.tableSET.get_string_tuple(),
                           doc='set table')
    speed_0x_val = pvproperty(name='V0X',
                              dtype=ChannelType.DOUBLE,
                              doc='speed 0X val',
                              read_only=True)
    speed_0y_val = pvproperty(name='V0Y',
                              dtype=ChannelType.DOUBLE,
                              doc='speed 0Y val',
                              read_only=True)
    speed_1y_val = pvproperty(name='V1Y',
                              dtype=ChannelType.DOUBLE,
                              doc='speed 1Y val',
                              read_only=True)
    speed_2x_val = pvproperty(name='V2X',
                              dtype=ChannelType.DOUBLE,
                              doc='speed 2X val',
                              read_only=True)
    speed_2y_val = pvproperty(name='V2Y',
                              dtype=ChannelType.DOUBLE,
                              doc='speed 2Y val',
                              read_only=True)
    speed_2z_val = pvproperty(name='V2Z',
                              dtype=ChannelType.DOUBLE,
                              doc='speed 2Z val',
                              read_only=True)
    sync_with_motors = pvproperty(name='SYNC',
                                  dtype=ChannelType.LONG,
                                  doc='sync with motors')
    x_angle = pvproperty(name='AX', dtype=ChannelType.DOUBLE, doc='x angle')
    x_angle_hi_limit = pvproperty(name='HLAX',
                                  dtype=ChannelType.DOUBLE,
                                  doc='x angle hi limit',
                                  read_only=True)
    x_angle_lo_limit = pvproperty(name='LLAX',
                                  dtype=ChannelType.DOUBLE,
                                  doc='x angle lo limit',
                                  read_only=True)
    x_angle_readback = pvproperty(name='AXRB',
                                  dtype=ChannelType.DOUBLE,
                                  doc='x angle readback',
                                  read_only=True)
    x_angle_true_value = pvproperty(name='AXL',
                                    dtype=ChannelType.DOUBLE,
                                    doc='x angle true value',
                                    read_only=True)
    x_hi_limit = pvproperty(name='HLX',
                            dtype=ChannelType.DOUBLE,
                            doc='x hi limit',
                            read_only=True)
    x_lo_limit = pvproperty(name='LLX',
                            dtype=ChannelType.DOUBLE,
                            doc='x lo limit',
                            read_only=True)
    x_offset = pvproperty(name='X0', dtype=ChannelType.DOUBLE, doc='x offset')
    x_readback_value = pvproperty(name='XRB',
                                  dtype=ChannelType.DOUBLE,
                                  doc='x readback value',
                                  read_only=True)
    x_translation = pvproperty(name='X',
                               dtype=ChannelType.DOUBLE,
                               doc='x translation')
    x_true_value = pvproperty(name='XL',
                              dtype=ChannelType.DOUBLE,
                              doc='x true value',
                              read_only=True)
    x_angle_offset = pvproperty(name='AX0',
                                dtype=ChannelType.DOUBLE,
                                doc='x-angle offset')
    y_angle = pvproperty(name='AY', dtype=ChannelType.DOUBLE, doc='y angle')
    y_angle_hi_limit = pvproperty(name='HLAY',
                                  dtype=ChannelType.DOUBLE,
                                  doc='y angle hi limit',
                                  read_only=True)
    y_angle_lo_limit = pvproperty(name='LLAY',
                                  dtype=ChannelType.DOUBLE,
                                  doc='y angle lo limit',
                                  read_only=True)
    y_angle_readback = pvproperty(name='AYRB',
                                  dtype=ChannelType.DOUBLE,
                                  doc='y angle readback',
                                  read_only=True)
    y_angle_true_value = pvproperty(name='AYL',
                                    dtype=ChannelType.DOUBLE,
                                    doc='y angle true value',
                                    read_only=True)
    y_hi_limit = pvproperty(name='HLY',
                            dtype=ChannelType.DOUBLE,
                            doc='y hi limit',
                            read_only=True)
    y_lo_limit = pvproperty(name='LLY',
                            dtype=ChannelType.DOUBLE,
                            doc='y lo limit',
                            read_only=True)
    y_offset = pvproperty(name='Y0', dtype=ChannelType.DOUBLE, doc='y offset')
    y_readback_value = pvproperty(name='YRB',
                                  dtype=ChannelType.DOUBLE,
                                  doc='y readback value',
                                  read_only=True)
    y_translation = pvproperty(name='Y',
                               dtype=ChannelType.DOUBLE,
                               doc='y translation')
    y_true_value = pvproperty(name='YL',
                              dtype=ChannelType.DOUBLE,
                              doc='y true value',
                              read_only=True)
    y_angle_offset = pvproperty(name='AY0',
                                dtype=ChannelType.DOUBLE,
                                doc='y-angle offset')
    z_angle = pvproperty(name='AZ', dtype=ChannelType.DOUBLE, doc='z angle')
    z_angle_hi_limit = pvproperty(name='HLAZ',
                                  dtype=ChannelType.DOUBLE,
                                  doc='z angle hi limit',
                                  read_only=True)
    z_angle_lo_limit = pvproperty(name='LLAZ',
                                  dtype=ChannelType.DOUBLE,
                                  doc='z angle lo limit',
                                  read_only=True)
    z_angle_readback = pvproperty(name='AZRB',
                                  dtype=ChannelType.DOUBLE,
                                  doc='z angle readback',
                                  read_only=True)
    z_angle_true_value = pvproperty(name='AZL',
                                    dtype=ChannelType.DOUBLE,
                                    doc='z angle true value',
                                    read_only=True)
    z_hi_limit = pvproperty(name='HLZ',
                            dtype=ChannelType.DOUBLE,
                            doc='z hi limit',
                            read_only=True)
    z_lo_limit = pvproperty(name='LLZ',
                            dtype=ChannelType.DOUBLE,
                            doc='z lo limit',
                            read_only=True)
    z_offset = pvproperty(name='Z0', dtype=ChannelType.DOUBLE, doc='z offset')
    z_readback_value = pvproperty(name='ZRB',
                                  dtype=ChannelType.DOUBLE,
                                  doc='z readback value',
                                  read_only=True)
    z_translation = pvproperty(name='Z',
                               dtype=ChannelType.DOUBLE,
                               doc='z translation')
    z_true_value = pvproperty(name='ZL',
                              dtype=ChannelType.DOUBLE,
                              doc='z true value',
                              read_only=True)
    z_angle_offset = pvproperty(name='AZ0',
                                dtype=ChannelType.DOUBLE,
                                doc='z-angle offset')
    zero_table = pvproperty(name='ZERO',
                            dtype=ChannelType.LONG,
                            doc='zero table')
    angular_units_name = pvproperty(name='AEGU',
                                    dtype=ChannelType.CHAR,
                                    max_length=16,
    ...
    display_precision = pvproperty(name='PREC',
                                   dtype=ChannelType.LONG,
                                   doc='Display Precision')
    geometry = pvproperty(name='GEOM',
                          dtype=ChannelType.ENUM,
                          enum_strings=menus.tableGEOM.get_string_tuple(),
                          doc='Geometry')
    linear_units_name = pvproperty(name='LEGU',
                                   dtype=ChannelType.CHAR,
                                   max_length=16,
                                   doc='Linear Units Name')
    orientation_angle = pvproperty(name='YANG',
                                   dtype=ChannelType.DOUBLE,
                                   doc='Orientation angle')
    encoder_0x_inlink = pvproperty(name='E0XI',
                                   dtype=ChannelType.STRING,
                                   doc='encoder 0X inlink',
                                   read_only=True)
    encoder_0y_inlink = pvproperty(name='E0YI',
                                   dtype=ChannelType.STRING,
                                   doc='encoder 0Y inlink',
                                   read_only=True)
    encoder_1y_inlink = pvproperty(name='E1YI',
                                   dtype=ChannelType.STRING,
                                   doc='encoder 1Y inlink',
                                   read_only=True)
    encoder_2x_inlink = pvproperty(name='E2XI',
                                   dtype=ChannelType.STRING,
                                   doc='encoder 2X inlink',
                                   read_only=True)
    encoder_2y_inlink = pvproperty(name='E2YI',
                                   dtype=ChannelType.STRING,
                                   doc='encoder 2Y inlink',
                                   read_only=True)
    encoder_2z_inlink = pvproperty(name='E2ZI',
                                   dtype=ChannelType.STRING,
                                   doc='encoder 2Z inlink',
                                   read_only=True)
    motor_0x_hlm_link = pvproperty(name='H0XL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 0X HLM link',
                                   read_only=True)
    motor_0x_llm_link = pvproperty(name='L0XL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 0X LLM link',
                                   read_only=True)
    motor_0x_rbv_link = pvproperty(name='R0XI',
                                   dtype=ChannelType.STRING,
                                   doc='motor 0X RBV link',
                                   read_only=True)
    motor_0x_outlink = pvproperty(name='M0XL',
                                  dtype=ChannelType.STRING,
                                  doc='motor 0X outlink',
                                  read_only=True)
    motor_0y_hlm_link = pvproperty(name='H0YL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 0Y HLM link',
                                   read_only=True)
    motor_0y_llm_link = pvproperty(name='L0YL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 0Y LLM link',
                                   read_only=True)
    motor_0y_rbv_link = pvproperty(name='R0YI',
                                   dtype=ChannelType.STRING,
                                   doc='motor 0Y RBV link',
                                   read_only=True)
    motor_0y_outlink = pvproperty(name='M0YL',
                                  dtype=ChannelType.STRING,
                                  doc='motor 0Y outlink',
                                  read_only=True)
    motor_1y_hlm_link = pvproperty(name='H1YL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 1Y HLM link',
                                   read_only=True)
    motor_1y_llm_link = pvproperty(name='L1YL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 1Y LLM link',
                                   read_only=True)
    motor_1y_rbv_link = pvproperty(name='R1YI',
                                   dtype=ChannelType.STRING,
                                   doc='motor 1Y RBV link',
                                   read_only=True)
    motor_1y_outlink = pvproperty(name='M1YL',
                                  dtype=ChannelType.STRING,
                                  doc='motor 1Y outlink',
                                  read_only=True)
    motor_2x_hlm_link = pvproperty(name='H2XL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 2X HLM link',
                                   read_only=True)
    motor_2x_llm_link = pvproperty(name='L2XL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 2X LLM link',
                                   read_only=True)
    motor_2x_rbv_link = pvproperty(name='R2XI',
                                   dtype=ChannelType.STRING,
                                   doc='motor 2X RBV link',
                                   read_only=True)
    motor_2x_outlink = pvproperty(name='M2XL',
                                  dtype=ChannelType.STRING,
                                  doc='motor 2X outlink',
                                  read_only=True)
    motor_2y_hlm_link = pvproperty(name='H2YL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 2Y HLM link',
                                   read_only=True)
    motor_2y_llm_link = pvproperty(name='L2YL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 2Y LLM link',
                                   read_only=True)
    motor_2y_rbv_link = pvproperty(name='R2YI',
                                   dtype=ChannelType.STRING,
                                   doc='motor 2Y RBV link',
                                   read_only=True)
    motor_2y_outlink = pvproperty(name='M2YL',
                                  dtype=ChannelType.STRING,
                                  doc='motor 2Y outlink',
                                  read_only=True)
    motor_2z_hlm_link = pvproperty(name='H2ZL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 2Z HLM link',
                                   read_only=True)
    motor_2z_llm_link = pvproperty(name='L2ZL',
                                   dtype=ChannelType.STRING,
                                   doc='motor 2Z LLM link',
                                   read_only=True)
    motor_2z_rbv_link = pvproperty(name='R2ZI',
                                   dtype=ChannelType.STRING,
                                   doc='motor 2Z RBV link',
                                   read_only=True)
    motor_2z_outlink = pvproperty(name='M2ZL',
                                  dtype=ChannelType.STRING,
                                  doc='motor 2Z outlink',
                                  read_only=True)
    speed_0x_inlink = pvproperty(name='V0XI',
                                 dtype=ChannelType.STRING,
                                 doc='speed 0X inlink',
                                 read_only=True)
    speed_0x_outlink = pvproperty(name='V0XL',
                                  dtype=ChannelType.STRING,
                                  doc='speed 0X outlink',
                                  read_only=True)
    speed_0y_inlink = pvproperty(name='V0YI',
                                 dtype=ChannelType.STRING,
                                 doc='speed 0Y inlink',
                                 read_only=True)
    speed_0y_outlink = pvproperty(name='V0YL',
                                  dtype=ChannelType.STRING,
                                  doc='speed 0Y outlink',
                                  read_only=True)
    speed_1y_inlink = pvproperty(name='V1YI',
                                 dtype=ChannelType.STRING,
                                 doc='speed 1Y inlink',
                                 read_only=True)
    speed_1y_outlink = pvproperty(name='V1YL',
                                  dtype=ChannelType.STRING,
                                  doc='speed 1Y outlink',
                                  read_only=True)
    speed_2x_inlink = pvproperty(name='V2XI',
                                 dtype=ChannelType.STRING,
                                 doc='speed 2X inlink',
                                 read_only=True)
    speed_2x_outlink = pvproperty(name='V2XL',
                                  dtype=ChannelType.STRING,
                                  doc='speed 2X outlink',
                                  read_only=True)
    speed_2y_inlink = pvproperty(name='V2YI',
                                 dtype=ChannelType.STRING,
                                 doc='speed 2Y inlink',
                                 read_only=True)
    speed_2y_outlink = pvproperty(name='V2YL',
                                  dtype=ChannelType.STRING,
                                  doc='speed 2Y outlink',
                                  read_only=True)
    speed_2z_inlink = pvproperty(name='V2ZI',
                                 dtype=ChannelType.STRING,
                                 doc='speed 2Z inlink',
                                 read_only=True)
    speed_2z_outlink = pvproperty(name='V2ZL',
                                  dtype=ChannelType.STRING,
                                  doc='speed 2Z outlink',
                                  read_only=True)
    wheelbase_x = pvproperty(name='LX',
                             dtype=ChannelType.DOUBLE,
                             doc='wheelbase x')
    wheelbase_z = pvproperty(name='LZ',
                             dtype=ChannelType.DOUBLE,
                             doc='wheelbase z')
    x_angle_user_hi_limit = pvproperty(name='UHAX',
                                       dtype=ChannelType.DOUBLE,
                                       doc='x angle user hi limit')
    x_angle_user_lo_limit = pvproperty(name='ULAX',
                                       dtype=ChannelType.DOUBLE,
                                       doc='x angle user lo limit')
    x_of_fixed_point = pvproperty(name='SX',
                                  dtype=ChannelType.DOUBLE,
                                  doc='x of fixed point')
    x_of_ref_point = pvproperty(name='RX',
                                dtype=ChannelType.DOUBLE,
                                doc='x of ref point')
    x_user_hi_limit = pvproperty(name='UHX',
                                 dtype=ChannelType.DOUBLE,
                                 doc='x user hi limit')
    x_user_lo_limit = pvproperty(name='ULX',
                                 dtype=ChannelType.DOUBLE,
                                 doc='x user lo limit')
    y_angle_user_hi_limit = pvproperty(name='UHAY',
                                       dtype=ChannelType.DOUBLE,
                                       doc='y angle user hi limit')
    y_angle_user_lo_limit = pvproperty(name='ULAY',
                                       dtype=ChannelType.DOUBLE,
                                       doc='y angle user lo limit')
    y_of_fixed_point = pvproperty(name='SY',
                                  dtype=ChannelType.DOUBLE,
                                  doc='y of fixed point')
    y_of_ref_point = pvproperty(name='RY',
                                dtype=ChannelType.DOUBLE,
                                doc='y of ref point')
    y_user_hi_limit = pvproperty(name='UHY',
                                 dtype=ChannelType.DOUBLE,
                                 doc='y user hi limit')
    y_user_lo_limit = pvproperty(name='ULY',
                                 dtype=ChannelType.DOUBLE,
                                 doc='y user lo limit')
    z_angle_user_hi_limit = pvproperty(name='UHAZ',
                                       dtype=ChannelType.DOUBLE,
                                       doc='z angle user hi limit')
    z_angle_user_lo_limit = pvproperty(name='ULAZ',
                                       dtype=ChannelType.DOUBLE,
                                       doc='z angle user lo limit')
    z_of_fixed_point = pvproperty(name='SZ',
                                  dtype=ChannelType.DOUBLE,
                                  doc='z of fixed point')
    z_of_ref_point = pvproperty(name='RZ',
                                dtype=ChannelType.DOUBLE,
                                doc='z of ref point')
    z_user_hi_limit = pvproperty(name='UHZ',
                                 dtype=ChannelType.DOUBLE,
                                 doc='z user hi limit')
    z_user_lo_limit = pvproperty(name='ULZ',
                                 dtype=ChannelType.DOUBLE,
                                 doc='z user lo limit')
    _link_parent_attribute(display_precision, 'precision')
...
class TransformFields(RecordFieldGroup):
    ...
    display_precision = pvproperty(name='PREC',
                                   dtype=ChannelType.LONG,
                                   doc='Display Precision')
    input_bitmap = pvproperty(name='MAP',
                              dtype=ChannelType.LONG,
                              doc='Input bitmap')
...
class VmeFields(RecordFieldGroup):
    ...
    alarm_status = pvproperty(
        ...
        doc='Alarm Status',
        read_only=True)
    status_array = pvproperty(name='SARR',
                              dtype=ChannelType.CHAR,
                              doc='Status array')
    read_write = pvproperty(name='RDWT',
                            dtype=ChannelType.ENUM,
    ...
    vme_data_size = pvproperty(name='DSIZ',
                               dtype=ChannelType.ENUM,
                               enum_strings=menus.vmeDSIZ.get_string_tuple(),
                               doc='VME data size')
    address_increment_1_4 = pvproperty(name='AINC',
                                       dtype=ChannelType.LONG,
                                       doc='Address increment (1-4)')
    max_number_of_values = pvproperty(name='NMAX',
                                      dtype=ChannelType.LONG,
                                      doc='Max. number of values')
    number_of_values_to_r_w = pvproperty(name='NUSE',
                                         dtype=ChannelType.LONG,
                                         doc='Number of values to R/W')
    vme_address_hex = pvproperty(name='ADDR',
                                 dtype=ChannelType.LONG,
                                 doc='VME address (hex)')
...
class VsFields(RecordFieldGroup):
    ...
    alarm_status = pvproperty(
        ...
        doc='Alarm Status',
        read_only=True)
    changed_control = pvproperty(name='CHGC',
                                 dtype=ChannelType.LONG,
                                 doc='Changed Control',
                                 read_only=True)
    controller_err_cnt = pvproperty(name='ERR',
                                    dtype=ChannelType.LONG,
                                    doc='Controller Err Cnt')
    controller_type = pvproperty(name='TYPE',
                                 dtype=ChannelType.ENUM,
                                 enum_strings=menus.vsTYPE.get_string_tuple(),
                                 doc='Controller Type')
    conv_a_log10_pressure = pvproperty(name='LCAP',
                                       dtype=ChannelType.DOUBLE,
                                       doc='Conv-A Log10 Pressure',
                                       read_only=True)
    conv_b_log10_pressure = pvproperty(name='LCBP',
                                       dtype=ChannelType.DOUBLE,
                                       doc='Conv-B Log10 Pressure',
                                       read_only=True)
    convectron_a_pressure = pvproperty(name='CGAP',
                                       dtype=ChannelType.DOUBLE,
                                       doc='Convectron-A Pressure',
                                       read_only=True)
    convectron_b_pressure = pvproperty(name='CGBP',
                                       dtype=ChannelType.DOUBLE,
                                       doc='Convectron-B Pressure',
                                       read_only=True)
    degas_read = pvproperty(name='DGSR',
                            dtype=ChannelType.ENUM,
                            enum_strings=menus.vsOFFON.get_string_tuple(),
                            doc='Degas Read',
                            read_only=True)
    fault_read = pvproperty(name='FLTR',
                            dtype=ChannelType.ENUM,
                            enum_strings=menus.vsOFFON.get_string_tuple(),
                            doc='Fault Read',
                            read_only=True)
    gauge_pressure = pvproperty(name='PRES',
                                dtype=ChannelType.DOUBLE,
                                doc='Gauge Pressure',
                                read_only=True)
    ig_last_value_alarmed = pvproperty(name='LALM',
                                       dtype=ChannelType.DOUBLE,
                                       doc='IG Last Value Alarmed',
                                       read_only=True)
    ig_log10_pressure = pvproperty(name='LPRS',
                                   dtype=ChannelType.DOUBLE,
    ...
    ion_gauge_2_read = pvproperty(
        ...
        read_only=True)
    sp_1_readback = pvproperty(name='SP1R',
                               dtype=ChannelType.DOUBLE,
                               doc='SP 1 Readback',
                               read_only=True)
    sp_1_setpoint_set = pvproperty(name='SP1S',
                                   dtype=ChannelType.DOUBLE,
                                   doc='SP 1 Setpoint Set')
    sp_2_readback = pvproperty(name='SP2R',
                               dtype=ChannelType.DOUBLE,
                               doc='SP 2 Readback',
                               read_only=True)
    sp_2_setpoint_set = pvproperty(name='SP2S',
                                   dtype=ChannelType.DOUBLE,
                                   doc='SP 2 Setpoint Set')
    sp_3_readback = pvproperty(name='SP3R',
                               dtype=ChannelType.DOUBLE,
                               doc='SP 3 Readback',
                               read_only=True)
    sp_3_setpoint_set = pvproperty(name='SP3S',
                                   dtype=ChannelType.DOUBLE,
                                   doc='SP 3 Setpoint Set')
    sp_4_readback = pvproperty(name='SP4R',
                               dtype=ChannelType.DOUBLE,
                               doc='SP 4 Readback',
                               read_only=True)
    sp_4_setpoint_set = pvproperty(name='SP4S',
                                   dtype=ChannelType.DOUBLE,
                                   doc='SP 4 Setpoint Set')
    set_point_1 = pvproperty(name='SP1',
                             dtype=ChannelType.ENUM,
                             enum_strings=menus.vsOFFON.get_string_tuple(),
                             doc='Set Point 1',
                             read_only=True)
    set_point_2 = pvproperty(name='SP2',
                             dtype=ChannelType.ENUM,
                             enum_strings=menus.vsOFFON.get_string_tuple(),
                             doc='Set Point 2',
                             read_only=True)
    set_point_3 = pvproperty(name='SP3',
                             dtype=ChannelType.ENUM,
                             enum_strings=menus.vsOFFON.get_string_tuple(),
                             doc='Set Point 3',
                             read_only=True)
    set_point_4 = pvproperty(name='SP4',
                             dtype=ChannelType.ENUM,
                             enum_strings=menus.vsOFFON.get_string_tuple(),
                             doc='Set Point 4',
                             read_only=True)
    set_point_5 = pvproperty(name='SP5',
                             dtype=ChannelType.ENUM,
                             enum_strings=menus.vsOFFON.get_string_tuple(),
                             doc='Set Point 5',
                             read_only=True)
    set_point_6 = pvproperty(name='SP6',
                             dtype=ChannelType.ENUM,
                             enum_strings=menus.vsOFFON.get_string_tuple(),
                             doc='Set Point 6',
                             read_only=True)
    prev_conv_a_log10_pres = pvproperty(name='PLCA',
                                        dtype=ChannelType.DOUBLE,
                                        doc='prev Conv-A Log10 Pres',
                                        read_only=True)
    prev_conv_a_pres = pvproperty(name='PCGA',
                                  dtype=ChannelType.DOUBLE,
                                  doc='prev Conv-A Pres',
                                  read_only=True)
    prev_conv_b_log10_pres = pvproperty(name='PLCB',
                                        dtype=ChannelType.DOUBLE,
                                        doc='prev Conv-B Log10 Pres',
                                        read_only=True)
    prev_conv_b_pres = pvproperty(name='PCGB',
                                  dtype=ChannelType.DOUBLE,
                                  doc='prev Conv-B Pres',
                                  read_only=True)
    prev_degas = pvproperty(name='PDGS',
                            dtype=ChannelType.ENUM,
                            enum_strings=menus.vsOFFON.get_string_tuple(),
                            doc='prev Degas',
                            read_only=True)
    prev_degas_pdss = pvproperty(name='PDSS',
                                 dtype=ChannelType.ENUM,
                                 enum_strings=menus.vsOFFON.get_string_tuple(),
                                 doc='prev Degas',
                                 read_only=True)
    prev_fault = pvproperty(name='PFLT',
                            dtype=ChannelType.ENUM,
                            enum_strings=menus.vsOFFON.get_string_tuple(),
                            doc='prev Fault',
                            read_only=True)
    prev_gauge_pres = pvproperty(name='PPRE',
                                 dtype=ChannelType.DOUBLE,
                                 doc='prev Gauge Pres',
                                 read_only=True)
    prev_gauge_pres_pval = pvproperty(name='PVAL',
                                      dtype=ChannelType.DOUBLE,
                                      doc='prev Gauge Pres',
                                      read_only=True)
    prev_ig_log10_pres = pvproperty(name='PLPE',
                                    dtype=ChannelType.DOUBLE,
    ...
    prev_ion_gauge_2_pig2 = pvproperty(
        ...
        doc='prev Ion Gauge 2',
        read_only=True)
    prev_sp1_readback = pvproperty(name='PS1R',
                                   dtype=ChannelType.DOUBLE,
                                   doc='prev SP1 Readback',
                                   read_only=True)
    prev_sp1_set = pvproperty(name='PS1S',
                              dtype=ChannelType.DOUBLE,
                              doc='prev SP1 Set',
                              read_only=True)
    prev_sp2_readback = pvproperty(name='PS2R',
                                   dtype=ChannelType.DOUBLE,
                                   doc='prev SP2 Readback',
                                   read_only=True)
    prev_sp2_set = pvproperty(name='PS2S',
                              dtype=ChannelType.DOUBLE,
                              doc='prev SP2 Set',
                              read_only=True)
    prev_sp3_readback = pvproperty(name='PS3R',
                                   dtype=ChannelType.DOUBLE,
                                   doc='prev SP3 Readback',
                                   read_only=True)
    prev_sp3_set = pvproperty(name='PS3S',
                              dtype=ChannelType.DOUBLE,
                              doc='prev SP3 Set',
                              read_only=True)
    prev_sp4_readback = pvproperty(name='PS4R',
                                   dtype=ChannelType.DOUBLE,
                                   doc='prev SP4 Readback',
                                   read_only=True)
    prev_sp4_set = pvproperty(name='PS4S',
                              dtype=ChannelType.DOUBLE,
                              doc='prev SP4 Set',
                              read_only=True)
    ...
    prev_set_point_6 = pvproperty(
        ...
        read_only=True)
    ion_gauge_1_set = pvproperty(name='IG1S',
                                 dtype=ChannelType.ENUM,
                                 enum_strings=menus.vsOFFON.get_string_tuple(),
                                 doc='Ion Gauge 1 Set')
    ion_gauge_2_set = pvproperty(name='IG2S',
                                 dtype=ChannelType.ENUM,
                                 enum_strings=menus.vsOFFON.get_string_tuple(),
                                 doc='Ion Gauge 2 Set')
    degas_set = pvproperty(name='DGSS',
                           dtype=ChannelType.ENUM,
                           enum_strings=menus.vsOFFON.get_string_tuple(),
                           doc='Degas Set')
    device_specification = pvproperty(name='INP',
                                      ...
                                      doc='Device Specification',
                                      read_only=True)
    ig_alarm_deadband = pvproperty(name='HYST',
                                   dtype=ChannelType.DOUBLE,
                                   doc='IG Alarm Deadband')
    ig_high_alarm = pvproperty(name='HIGH',
                               dtype=ChannelType.DOUBLE,
                               doc='IG High Alarm')
    ...
    ig_hihi_alarm = pvproperty(name='HIHI',
                               dtype=ChannelType.DOUBLE,
                               doc='IG Hihi Alarm')
    ...
    ig_lolo_alarm = pvproperty(name='LOLO',
                               dtype=ChannelType.DOUBLE,
                               doc='IG Lolo Alarm')
    ...
    ig_low_alarm = pvproperty(name='LOW',
                              dtype=ChannelType.DOUBLE,
                              doc='IG Low Alarm')
    ig_low_severity = pvproperty(
        ...
        enum_strings=menus.menuAlarmSevr.get_string_tuple(),
        doc='IG Low Severity')
    ig_pres_high_display = pvproperty(name='HOPR',
                                      dtype=ChannelType.DOUBLE,
                                      doc='IG Pres High Display')
    ig_pres_low_display = pvproperty(name='LOPR',
                                     dtype=ChannelType.DOUBLE,
                                     doc='IG Pres Low Display')
    ig_log10_high_display = pvproperty(name='HLPR',
                                       dtype=ChannelType.DOUBLE,
                                       doc='IG Log10 High Display')
    ig_log10_low_display = pvproperty(name='LLPR',
                                      dtype=ChannelType.DOUBLE,
                                      doc='IG Log10 Low Display')
    cga_pres_high_display = pvproperty(name='HAPR',
                                       dtype=ChannelType.DOUBLE,
                                       doc='CGA Pres High Display')
    cga_pres_low_display = pvproperty(name='LAPR',
                                      dtype=ChannelType.DOUBLE,
                                      doc='CGA Pres Low Display')
    cga_log10_high_display = pvproperty(name='HALR',
                                        dtype=ChannelType.DOUBLE,
                                        doc='CGA Log10 High Display')
    cga_log10_low_display = pvproperty(name='LALR',
                                       dtype=ChannelType.DOUBLE,
                                       doc='CGA Log10 Low Display')
    cgb_pres_high_display = pvproperty(name='HBPR',
                                       dtype=ChannelType.DOUBLE,
                                       doc='CGB Pres High Display')
    cgb_pres_low_display = pvproperty(name='LBPR',
                                      dtype=ChannelType.DOUBLE,
                                      doc='CGB Pres Low Display')
    cgb_log10_high_display = pvproperty(name='HBLR',
                                        dtype=ChannelType.DOUBLE,
                                        doc='CGB Log10 High Display')
    cgb_log10_low_display = pvproperty(name='LBLR',
                                       dtype=ChannelType.DOUBLE,
                                       doc='CGB Log10 Low Display')
