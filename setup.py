...
setup(name='caproto',
      ...
      entry_points={
          'console_scripts': [
              'caproto-get = caproto.comamndline.get:main',
              'caproto-put = caproto.comamndline.put:main',
              'caproto-monitor = caproto.comamndline.monitor:main',
              'caproto-repeater = caproto.comamndline.repeater:main',
